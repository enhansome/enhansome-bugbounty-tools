...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,115 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,395 | 🐛 18 | 🌐 Go | 📅 2026-09-02 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,033 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool for penetration testers
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,543 | 🐛 46 | 🌐 Python | 📅 2026-09-06 - A recursive internet scanner for hackers
* [knock](https://github.com/guelfoweb/knock) ⭐ 4,192 | 🐛 71 | 🌐 Python | 📅 2026-02-19 - Knockpy is a python tool designed to enumerate subdomains on a target domain through a wordlist.
...
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,672 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,863 | 🐛 13 | 🌐 Go | 📅 2026-09-07 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [puredns](https://github.com/d3mondev/puredns) ⭐ 2,240 | 🐛 16 | 🌐 Go | 📅 2026-02-23 - Fast domain resolver and subdomain bruteforcing with accurate wildcard filtering with wildcard(\*)
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,672 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,988 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,381 | 🐛 61 | 🌐 Rust | 📅 2026-09-07 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,533 | 🐛 684 | 🌐 C | 📅 2026-09-06 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,232 | 🐛 1 | 🌐 Go | 📅 2026-09-07 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,840 | 🐛 29 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
...
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,992 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,368 | 🐛 18 | 🌐 Go | 📅 2026-09-05 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,822 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,536 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,169 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-23 - scanner detecting the use of JavaScript libraries with known vulnerabilities
* [webanalyze](https://github.com/rverton/webanalyze) ⭐ 1,172 | 🐛 4 | 🌐 Go | 📅 2026-08-28 - Port of Wappalyzer (uncovers technologies used on websites) to automate mass scanning.
* [tlsx](https://github.com/projectdiscovery/tlsx) ⭐ 1,139 | 🐛 7 | 🌐 Go | 📅 2026-09-07 - A fast and configurable TLS grabber focused on TLS based data collection and analysis.
* [cdncheck](https://github.com/projectdiscovery/cdncheck) ⭐ 988 | 🐛 14 | 🌐 Go | 📅 2026-09-07 - cdncheck is a tool for identifying the technology associated with dns / ip network addresses.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,403 | 🐛 51 | 🌐 Go | 📅 2026-09-07 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,698 | 🐛 22 | 🌐 Python | 📅 2026-09-06 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,091 | 🐛 23 | 🌐 Go | 📅 2026-09-03 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,058 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
* [hakrawler](https://github.com/hakluke/hakrawler) ⭐ 5,120 | 🐛 9 | 🌐 Go | 📅 2026-08-05 - Simple, fast web crawler designed for easy, quick discovery of endpoints and assets within a web application
* [kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,254 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - Fast API endpoint bruteforcer and content discovery tool for modern web applications.
...
* [gau](https://github.com/lc/gau) ⭐ 5,083 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
...
* [URLFinder](https://github.com/projectdiscovery/urlfinder) ⭐ 909 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - A high-speed tool for passively gathering URLs, optimized for efficient web asset discovery without active scanning.
...
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,167 | 🐛 37 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of Web Archives.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,650 | 🐛 234 | 🌐 Go | 📅 2026-08-20 -  Fast web fuzzer written in Go
...
* [bbscope](https://github.com/sw33tLie/bbscope) ⭐ 1,434 | 🐛 17 | 🌐 Go | 📅 2026-09-02 - Scope aggregation tool for HackerOne, Bugcrowd, Intigriti, YesWeHack, Immunefi
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,837 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Automated All-in-One OS command injection and exploitation tool.
...
* [inql](https://github.com/doyensec/inql) ⭐ 1,806 | 🐛 31 | 🌐 Kotlin | 📅 2026-09-07 - InQL - A Burp Extension for GraphQL Security Testing
...
* [clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,516 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Obtain GraphQL API schema despite disabled introspection!
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,047 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
* [phpggc](https://github.com/ambionics/phpggc) ⭐ 3,883 | 🐛 22 | 🌐 PHP | 📅 2025-09-29 - PHPGGC is a library of PHP unserialize() payloads along with a tool to generate them, from command line or programmatically.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,385 | 🐛 32 | 🌐 Python | 📅 2026-09-07 - Automatic SQL injection and database takeover tool
...
* [NoSQLMap](https://github.com/codingo/NoSQLMap) ⭐ 3,348 | 🐛 1 | 🌐 Python | 📅 2026-07-28 - Automated NoSQL database enumeration and web application exploitation tool.
...
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,279 | 🐛 0 | 🌐 Rust | 📅 2026-09-07 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,633 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - Automatic SSTI detection tool with interactive interface
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,245 | 🐛 49 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,736 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,151 | 🐛 473 | 🌐 Go | 📅 2026-08-26 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,711 | 🐛 546 | 🌐 Go | 📅 2026-09-07 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
...
* [keyhacks](https://github.com/streaak/keyhacks) ⭐ 6,331 | 🐛 45 | 📅 2026-08-07 - KeyHacks shows methods to validate different API keys found on a Bug Bounty Program or a pentest.
...
* [SecretFinder](https://github.com/m4ll0k/SecretFinder) ⭐ 2,507 | 🐛 49 | 🌐 Python | 📅 2024-05-26 - A python script for finding sensitive data (apikeys, accesstoken,jwt,..) and search anything on javascript files.
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,388 | 🐛 11 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [talisman](https://github.com/thoughtworks/talisman) ⭐ 2,097 | 🐛 38 | 🌐 Go | 📅 2026-03-01 - By hooking into the pre-push hook provided by Git, Talisman validates the outgoing changeset for things that look suspicious - such as authorization tokens and private keys.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,455 | 🐛 166 | 🌐 Rust | 📅 2026-09-07 - Static analysis tool for GitHub Actions
...
* [festin](https://github.com/cr0hn/festin) ⭐ 233 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - FestIn - S3 Bucket Weakness Discovery
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,954 | 🐛 611 | 🌐 Ruby | 📅 2026-09-07 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,059 | 🐛 105 | 🌐 Go | 📅 2026-09-07 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,746 | 🐛 861 | 🌐 Java | 📅 2026-09-03 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,926 | 🐛 121 | 🌐 JavaScript | 📅 2026-09-07 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,208 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,716 | 🐛 1 | 🌐 Perl | 📅 2026-09-07 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,553 | 🐛 11 | 🌐 Go | 📅 2026-08-08 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,169 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-23 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,633 | 🐛 13 | 🌐 Python | 📅 2026-08-25 -  SSTImap is a penetration testing software that can check websites for Code Injection and Server-Side Template Injection vulnerabilities and exploit them, giving access to the operating system itself.
...
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,061 | 🐛 6 | 🌐 Go | 📅 2026-09-04 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,943 | 🐛 483 | 🌐 Python | 📅 2026-09-01 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,746 | 🐛 861 | 🌐 Java | 📅 2026-09-03 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,338 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
* [proxify](https://github.com/projectdiscovery/proxify) ⭐ 3,067 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - A versatile and portable proxy for capturing, manipulating, and replaying HTTP/HTTPS traffic on the go.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,765 | 🐛 559 | 🌐 JavaScript | 📅 2026-09-07 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,524 | 🐛 10 | 🌐 Go | 📅 2026-09-05 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,815 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-03 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,269 | 🐛 74 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,720 | 🐛 3 | 🌐 Python | 📅 2026-09-04 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 893 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,699 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,339 | 🐛 13 | 🌐 PHP | 📅 2026-09-07 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,675 | 🐛 2 | 🌐 Makefile | 📅 2026-09-07 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,941 | 🐛 0 | 📅 2026-09-07 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,529 | 🐛 14 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,651 | 🐛 12 | 🌐 Go | 📅 2026-09-07 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [mapcidr](https://github.com/projectdiscovery/mapcidr) ⭐ 1,223 | 🐛 0 | 🌐 Go | 📅 2026-09-05 - Utility program to perform multiple operations for a given subnet/CIDR ranges.
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 376 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
