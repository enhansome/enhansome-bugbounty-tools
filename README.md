...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,180 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,450 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,040 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool for penetration testers
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,593 | 🐛 50 | 🌐 Python | 📅 2026-09-17 - A recursive internet scanner for hackers
...
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,681 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,874 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,673 | 🐛 4 | 🌐 Go | 📅 2026-09-14 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [csprecon](https://github.com/edoardottt/csprecon) ⭐ 527 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - Discover new target domains using Content Security Policy
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,026 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,427 | 🐛 53 | 🌐 Rust | 📅 2026-09-18 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,604 | 🐛 697 | 🌐 C | 📅 2026-09-17 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,252 | 🐛 1 | 🌐 Go | 📅 2026-09-14 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,854 | 🐛 30 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
* [Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived - Recovers passwords from pixelized screenshots
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,513 | 🐛 36 | 🌐 Go | 📅 2026-09-16 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,051 | 🐛 3 | 🌐 Python | 📅 2026-09-18 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,407 | 🐛 11 | 🌐 Go | 📅 2026-09-16 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,845 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,551 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,174 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-14 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,521 | 🐛 24 | 🌐 Go | 📅 2026-09-14 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,737 | 🐛 23 | 🌐 Python | 📅 2026-09-17 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,129 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,073 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
* [hakrawler](https://github.com/hakluke/hakrawler) ⭐ 5,131 | 🐛 9 | 🌐 Go | 📅 2026-08-05 - Simple, fast web crawler designed for easy, quick discovery of endpoints and assets within a web application
* [kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,264 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - Fast API endpoint bruteforcer and content discovery tool for modern web applications.
* [uncover](https://github.com/projectdiscovery/uncover) ⭐ 3,055 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - uncover is a go wrapper using APIs of well known search engines to quickly discover exposed hosts on the internet.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,690 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,344 | 🐛 74 | 🌐 Swift | 📅 2026-09-16 - A JavaScript Engine Fuzzer
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,847 | 🐛 4 | 🌐 Python | 📅 2026-09-18 - Automated All-in-One OS command injection and exploitation tool.
...
* [LFISuite](https://github.com/D35m0nd142/LFISuite) ⭐ 1,967 | 🐛 28 | 🌐 Python | 📅 2022-04-13 - Totally Automatic LFI Exploiter (+ Reverse Shell) and Scanner
* [liffy](https://github.com/mzfr/liffy) ⭐ 990 | 🐛 1 | 🌐 Python | 📅 2026-05-19 - Local file inclusion exploitation tool
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,464 | 🐛 31 | 🌐 Python | 📅 2026-09-18 - Automatic SQL injection and database takeover tool
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,187 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,293 | 🐛 0 | 🌐 Rust | 📅 2026-09-16 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [nowafpls](https://github.com/assetnote/nowafpls/) ⭐ 1,505 | 🐛 4 | 🌐 Python | 📅 2025-07-14 - Burp Plugin to Bypass WAFs through the insertion of Junk Data.
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,280 | 🐛 50 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,745 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,375 | 🐛 482 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,982 | 🐛 557 | 🌐 Go | 📅 2026-09-17 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,773 | 🐛 14 | 🌐 Go | 📅 2026-09-07 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,427 | 🐛 12 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,532 | 🐛 162 | 🌐 Rust | 📅 2026-09-18 - Static analysis tool for GitHub Actions
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,774 | 🐛 2 | 🌐 Ruby | 📅 2026-09-18 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,023 | 🐛 605 | 🌐 Ruby | 📅 2026-09-17 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,288 | 🐛 107 | 🌐 Go | 📅 2026-09-18 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,785 | 🐛 861 | 🌐 Java | 📅 2026-09-18 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,986 | 🐛 119 | 🌐 JavaScript | 📅 2026-09-18 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,250 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,732 | 🐛 1 | 🌐 Perl | 📅 2026-09-18 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,569 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,174 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-14 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [getsploit](https://github.com/vulnersCom/getsploit) ⭐ 1,820 | 🐛 5 | 🌐 Python | 📅 2026-09-14 - Command line utility for searching and downloading exploits
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,085 | 🐛 491 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,785 | 🐛 861 | 🌐 Java | 📅 2026-09-18 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,491 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,873 | 🐛 592 | 🌐 JavaScript | 📅 2026-09-18 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
...
* [notify](https://github.com/projectdiscovery/notify) ⭐ 1,616 | 🐛 10 | 🌐 Go | 📅 2026-09-14 - Notify is a Go-based assistance package that enables you to stream the output of several tools (or read from a file) and publish it to a variety of supported platforms.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 48,133 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-08 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,517 | 🐛 81 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,931 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 948 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,955 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,587 | 🐛 9 | 🌐 PHP | 📅 2026-09-18 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,699 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,955 | 🐛 0 | 📅 2026-09-18 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
...
* [BigBountyRecon](https://github.com/Viralmaniar/BigBountyRecon) ⭐ 1,570 | 🐛 9 | 🌐 C# | 📅 2021-01-29 - BigBountyRecon tool utilises 58 different techniques using various Google dorks and open source tools to expedite the process of initial reconnaissance on the target organisation.
* [awesome-vulnerable-apps](https://github.com/vavkamil/awesome-vulnerable-apps) ⭐ 1,481 | 🐛 3 | 📅 2026-06-15 - Awesome Vulnerable Applications
...
* [asnmap](https://github.com/projectdiscovery/asnmap) ⭐ 1,129 | 🐛 6 | 🌐 Go | 📅 2026-09-07 - Go CLI and Library for quickly mapping organization network ranges using ASN information.
