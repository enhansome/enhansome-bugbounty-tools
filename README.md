...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,203 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,478 | 🐛 6 | 🌐 Go | 📅 2026-09-22 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,612 | 🐛 49 | 🌐 Python | 📅 2026-09-22 - A recursive internet scanner for hackers
...
* [csprecon](https://github.com/edoardottt/csprecon) ⭐ 529 | 🐛 3 | 🌐 Go | 📅 2026-09-21 - Discover new target domains using Content Security Policy
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,029 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,438 | 🐛 53 | 🌐 Rust | 📅 2026-09-21 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,650 | 🐛 700 | 🌐 C | 📅 2026-09-22 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,262 | 🐛 1 | 🌐 Go | 📅 2026-09-21 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,518 | 🐛 36 | 🌐 Go | 📅 2026-09-16 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,956 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,419 | 🐛 11 | 🌐 Go | 📅 2026-09-16 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,847 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,546 | 🐛 27 | 🌐 Go | 📅 2026-09-21 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,751 | 🐛 24 | 🌐 Python | 📅 2026-09-22 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,146 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,079 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [gospider](https://github.com/jaeles-project/gospider) ⭐ 3,000 | 🐛 57 | 🌐 Go | 📅 2024-04-21 - Gospider - Fast web spider written in Go
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,703 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,582 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
* [IntruderPayloads](https://github.com/1N3/IntruderPayloads) ⭐ 3,980 | 🐛 4 | 🌐 BlitzBasic | 📅 2021-09-27 - A collection of Burpsuite Intruder payloads, BurpBounty payloads, fuzz lists, malicious file uploads and web pentesting methodologies and checklists.
...
* [clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,525 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Obtain GraphQL API schema despite disabled introspection!
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,490 | 🐛 32 | 🌐 Python | 📅 2026-09-20 - Automatic SQL injection and database takeover tool
* [ghauri](https://github.com/r0oth3x49/ghauri) ⭐ 4,081 | 🐛 25 | 🌐 Python | 📅 2025-10-04 - An advanced cross-platform tool that automates the process of detecting and exploiting SQL injection security flaws
...
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,298 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [XXEinjector](https://github.com/enjoiz/XXEinjector) ⭐ 1,802 | 🐛 0 | 🌐 Ruby | 📅 2024-12-01 - Tool for automatic exploitation of XXE vulnerability using direct and different out of band methods.
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,294 | 🐛 50 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,752 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
...
* [BruteX](https://github.com/1N3/BruteX) ⭐ 2,305 | 🐛 10 | 🌐 Shell | 📅 2024-08-18 - Automatically brute force all services running on a target.
* [changeme](https://github.com/ztgrace/changeme) ⭐ 1,516 | 🐛 16 | 🌐 Python | 📅 2025-07-08 - A default credential scanner.

### Secrets

* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,427 | 🐛 483 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 28,020 | 🐛 564 | 🌐 Go | 📅 2026-09-22 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
...
* [shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,984 | 🐛 33 | 🌐 JavaScript | 📅 2025-02-28 - Ah shhgit! Find GitHub secrets in real time
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,778 | 🐛 14 | 🌐 Go | 📅 2026-09-21 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,432 | 🐛 12 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 717 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - A Chrome extension that passively scans web pages for API keys, tokens, and secrets using 80+ regex patterns and Shannon entropy analysis across 10 attack surfaces.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,555 | 🐛 160 | 🌐 Rust | 📅 2026-09-21 - Static analysis tool for GitHub Actions
...
* [S3Scanner](https://github.com/sa7mon/S3Scanner) ⭐ 3,173 | 🐛 41 | 🌐 Go | 📅 2026-08-03 - Scan for open AWS S3 buckets and dump the contents
...
* [jwt\_tool](https://github.com/ticarpi/jwt_tool) ⭐ 6,765 | 🐛 74 | 🌐 Python | 📅 2025-05-01 - A toolkit for testing, tweaking and cracking JSON Web Tokens
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,037 | 🐛 611 | 🌐 Ruby | 📅 2026-09-21 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,428 | 🐛 109 | 🌐 Go | 📅 2026-09-22 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,804 | 🐛 865 | 🌐 Java | 📅 2026-09-22 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 13,012 | 🐛 107 | 🌐 JavaScript | 📅 2026-09-22 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,264 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,734 | 🐛 1 | 🌐 Perl | 📅 2026-09-22 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,578 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,178 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,778 | 🐛 14 | 🌐 Go | 📅 2026-09-21 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
* [jaeles](https://github.com/jaeles-project/jaeles) ⭐ 2,374 | 🐛 32 | 🌐 Go | 📅 2026-06-20 - The Swiss Army knife for automated Web Application Testing
...
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,081 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,121 | 🐛 493 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,804 | 🐛 865 | 🌐 Java | 📅 2026-09-22 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,497 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,907 | 🐛 585 | 🌐 JavaScript | 📅 2026-09-21 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,544 | 🐛 8 | 🌐 Go | 📅 2026-09-09 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 48,283 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-21 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,561 | 🐛 87 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 5,124 | 🐛 7 | 🌐 Python | 📅 2026-09-22 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 963 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 81,095 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,668 | 🐛 10 | 🌐 PHP | 📅 2026-09-22 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,705 | 🐛 0 | 🌐 Makefile | 📅 2026-09-22 - A collection of android security related resources
...
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,546 | 🐛 12 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,668 | 🐛 14 | 🌐 Go | 📅 2026-09-21 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
