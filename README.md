...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,145 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,416 | 🐛 6 | 🌐 Go | 📅 2026-09-11 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,563 | 🐛 48 | 🌐 Python | 📅 2026-09-07 - A recursive internet scanner for hackers
* [knock](https://github.com/guelfoweb/knock) ⭐ 4,196 | 🐛 72 | 🌐 Python | 📅 2026-02-19 - Knockpy is a python tool designed to enumerate subdomains on a target domain through a wordlist.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,794 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - The fastest and cross-platform subdomain enumerator, do not waste your time.
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,676 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,865 | 🐛 3 | 🌐 Go | 📅 2026-09-08 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,671 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [scilla](https://github.com/edoardottt/scilla) ⭐ 1,267 | 🐛 6 | 🌐 Go | 📅 2026-09-09 - Information Gathering tool - DNS / Subdomains / Ports / Directories enumeration
...
* [subdominator](https://github.com/RevoltSecurities/Subdominator) ⭐ 810 | 🐛 5 | 🌐 Python | 📅 2026-06-21 - Fast and powerfull to enumerate subdomains (50+ passive results ).
...
* [csprecon](https://github.com/edoardottt/csprecon) ⭐ 526 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - Discover new target domains using Content Security Policy
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,999 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,398 | 🐛 62 | 🌐 Rust | 📅 2026-09-09 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,561 | 🐛 687 | 🌐 C | 📅 2026-09-11 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,238 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - A fast port scanner written in go with focus on reliability and simplicity.
* [sandmap](https://github.com/trimstray/sandmap) ⭐ 1,863 | 🐛 13 | 🌐 Shell | 📅 2024-11-19 - Nmap on steroids. Simple CLI with the ability to run pure Nmap engine, 31 modules with 459 scan profiles.
* [ScanCannon](https://github.com/johnnyxmas/ScanCannon) ⭐ 480 | 🐛 3 | 🌐 Shell | 📅 2026-08-11 - Combines the speed of masscan with the reliability and detailed enumeration of nmap
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,845 | 🐛 30 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
* [Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived - Recovers passwords from pixelized screenshots
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,504 | 🐛 43 | 🌐 Go | 📅 2026-04-22 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,010 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,385 | 🐛 7 | 🌐 Go | 📅 2026-09-11 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,832 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,545 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,170 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-11 - scanner detecting the use of JavaScript libraries with known vulnerabilities
* [webanalyze](https://github.com/rverton/webanalyze) ⭐ 1,175 | 🐛 4 | 🌐 Go | 📅 2026-08-28 - Port of Wappalyzer (uncovers technologies used on websites) to automate mass scanning.
...
* [cdncheck](https://github.com/projectdiscovery/cdncheck) ⭐ 988 | 🐛 6 | 🌐 Go | 📅 2026-09-08 - cdncheck is a tool for identifying the technology associated with dns / ip network addresses.
* [graphw00f](https://github.com/dolevf/graphw00f) ⭐ 899 | 🐛 3 | 🌐 Python | 📅 2026-05-16 - graphw00f is GraphQL Server Engine Fingerprinting utility for software security professionals looking to learn more about what technology is behind a given GraphQL endpoint.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,466 | 🐛 16 | 🌐 Go | 📅 2026-09-11 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,714 | 🐛 23 | 🌐 Python | 📅 2026-09-11 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,107 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,063 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
* [hakrawler](https://github.com/hakluke/hakrawler) ⭐ 5,125 | 🐛 9 | 🌐 Go | 📅 2026-08-05 - Simple, fast web crawler designed for easy, quick discovery of endpoints and assets within a web application
* [kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,261 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - Fast API endpoint bruteforcer and content discovery tool for modern web applications.
* [uncover](https://github.com/projectdiscovery/uncover) ⭐ 3,054 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - uncover is a go wrapper using APIs of well known search engines to quickly discover exposed hosts on the internet.
...
* [dirbuster-ng](https://github.com/digination/dirbuster-ng) ⭐ 358 | 🐛 5 | 🌐 C | 📅 2020-07-19 - dirbuster-ng is C CLI implementation of the Java dirbuster tool
* [crawley](https://github.com/s0rg/crawley) ⭐ 340 | 🐛 8 | 🌐 Go | 📅 2026-08-21 - fast, feature-rich unix-way web scraper/crawler written in Golang.
...
* [gau](https://github.com/lc/gau) ⭐ 5,087 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
* [waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,556 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all the URLs that the Wayback Machine knows about for a domain
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,443 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - A python script that finds endpoints in JavaScript files
* [waymore](https://github.com/xnl-h4ck3r/waymore) ⭐ 2,742 | 🐛 4 | 🌐 Python | 📅 2026-06-11 -  Find way more from the Wayback Machine!
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,920 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [URLFinder](https://github.com/projectdiscovery/urlfinder) ⭐ 912 | 🐛 2 | 🌐 Go | 📅 2026-09-07 - A high-speed tool for passively gathering URLs, optimized for efficient web asset discovery without active scanning.
* [getJS](https://github.com/003random/getJS) ⭐ 897 | 🐛 1 | 🌐 Go | 📅 2026-08-29 -  A tool to fastly get all javascript sources/files
...
* [GoLinkFinder](https://github.com/0xsha/GoLinkFinder) ⭐ 392 | 🐛 1 | 🌐 Go | 📅 2024-11-10 - A fast and minimal JS endpoint extractor
...
* [github-endpoints](https://github.com/gwen001/github-endpoints) ⭐ 224 | 🐛 5 | 🌐 Go | 📅 2023-03-28 - This Go tool performs searches on GitHub and parses the results to find endpoints of a given domain.
...
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,170 | 🐛 38 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of Web Archives.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,664 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,576 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
...
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,326 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,342 | 🐛 74 | 🌐 Swift | 📅 2026-09-10 - A JavaScript Engine Fuzzer
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,838 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Automated All-in-One OS command injection and exploitation tool.
...
* [crlfuzz](https://github.com/dwisiswant0/crlfuzz) ⭐ 1,564 | 🐛 1 | 🌐 Go | 📅 2026-08-28 - A fast tool to scan CRLF vulnerability written in Go
...
* [LFISuite](https://github.com/D35m0nd142/LFISuite) ⭐ 1,966 | 🐛 28 | 🌐 Python | 📅 2022-04-13 - Totally Automatic LFI Exploiter (+ Reverse Shell) and Scanner
* [liffy](https://github.com/mzfr/liffy) ⭐ 987 | 🐛 1 | 🌐 Python | 📅 2026-05-19 - Local file inclusion exploitation tool
...
* [inql](https://github.com/doyensec/inql) ⭐ 1,809 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-09 - InQL - A Burp Extension for GraphQL Security Testing
...
* [clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,519 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Obtain GraphQL API schema despite disabled introspection!
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,053 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
* [phpggc](https://github.com/ambionics/phpggc) ⭐ 3,885 | 🐛 22 | 🌐 PHP | 📅 2025-09-29 - PHPGGC is a library of PHP unserialize() payloads along with a tool to generate them, from command line or programmatically.
* [ysoserial.net](https://github.com/pwntester/ysoserial.net) ⭐ 3,788 | 🐛 11 | 🌐 C# | 📅 2026-09-07 - Deserialization payload generator for a variety of .NET formatters
...
* [SSRFmap](https://github.com/swisskyrepo/SSRFmap) ⭐ 3,620 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - Automatic SSRF fuzzer and exploitation tool
...
* [ssrf-sheriff](https://github.com/teknogeek/ssrf-sheriff) ⭐ 340 | 🐛 1 | 🌐 Go | 📅 2024-10-31 - A simple SSRF-testing sheriff written in Go
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,413 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - Automatic SQL injection and database takeover tool
...
* [NoSQLMap](https://github.com/codingo/NoSQLMap) ⭐ 3,350 | 🐛 1 | 🌐 Python | 📅 2026-07-28 - Automated NoSQL database enumeration and web application exploitation tool.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,177 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,289 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [CSPBypass](https://github.com/renniepak/CSPBypass) ⭐ 716 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 - a tool designed to help bypass restrictive Content Security Policies (CSP) and exploit XSS (Cross-Site Scripting) vulnerabilities on sites where injections are blocked by CSPs that only allow certain whitelisted domains.
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,639 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - Automatic SSTI detection tool with interactive interface
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,874 | 🐛 4 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,260 | 🐛 49 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,234 | 🐛 474 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,787 | 🐛 555 | 🌐 Go | 📅 2026-09-10 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,391 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
...
* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,634 | 🐛 178 | 🌐 Python | 📅 2026-04-02 - An enterprise friendly way of detecting and preventing secrets in code.
* [shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,981 | 🐛 33 | 🌐 JavaScript | 📅 2025-02-28 - Ah shhgit! Find GitHub secrets in real time
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,767 | 🐛 14 | 🌐 Go | 📅 2026-09-07 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
* [SecretFinder](https://github.com/m4ll0k/SecretFinder) ⭐ 2,509 | 🐛 49 | 🌐 Python | 📅 2024-05-26 - A python script for finding sensitive data (apikeys, accesstoken,jwt,..) and search anything on javascript files.
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,395 | 🐛 12 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [GitHound](https://github.com/tillson/git-hound) ⭐ 1,456 | 🐛 4 | 🌐 Go | 📅 2026-02-10 - Recon tool leveraging Code Search API. Scans for exposed API keys across all of GitHub, not just known repos and orgs. Support for GitHub dorks.
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 710 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - A Chrome extension that passively scans web pages for API keys, tokens, and secrets using 80+ regex patterns and Shannon entropy analysis across 10 attack surfaces.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,479 | 🐛 161 | 🌐 Rust | 📅 2026-09-11 - Static analysis tool for GitHub Actions
...
* [git-dumper](https://github.com/arthaud/git-dumper) ⭐ 2,657 | 🐛 10 | 🌐 Python | 📅 2026-09-06 - A tool to dump a git repository from a website
...
* [s3dns](https://github.com/olizimmermann/s3dns) ⭐ 128 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Passive DNS-based discovery of S3 (and other cloud) buckets by resolving CNAMEs and IPs during recon—ideal for stealthy and early identification of cloud storage exposures
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,762 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [wprecon](https://github.com/blackcrw/wprecon) ⭐ 23 | 🐛 0 | 🌐 Go | 📅 2026-06-05 - Wordpress Recon
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,081 | 🐛 0 | 🌐 Rust | 📅 2026-09-06 - jwt-hack is tool for hacking / security testing to JWT.
...
* [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) ⭐ 5,807 | 🐛 215 | 🌐 Python | 📅 2025-02-08 - "Can I take over XYZ?" — a list of services and how to claim (sub)domains with dangling DNS records.
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,983 | 🐛 608 | 🌐 Ruby | 📅 2026-09-10 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,114 | 🐛 98 | 🌐 Go | 📅 2026-09-11 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,763 | 🐛 862 | 🌐 Java | 📅 2026-09-10 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,949 | 🐛 116 | 🌐 JavaScript | 📅 2026-09-11 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,223 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,722 | 🐛 1 | 🌐 Perl | 📅 2026-09-11 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,558 | 🐛 10 | 🌐 Go | 📅 2026-08-08 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,170 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-11 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [getsploit](https://github.com/vulnersCom/getsploit) ⭐ 1,818 | 🐛 5 | 🌐 Python | 📅 2026-08-31 - Command line utility for searching and downloading exploits
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,639 | 🐛 13 | 🌐 Python | 📅 2026-08-25 -  SSTImap is a penetration testing software that can check websites for Code Injection and Server-Side Template Injection vulnerabilities and exploit them, giving access to the operating system itself.
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,089 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,068 | 🐛 6 | 🌐 Go | 📅 2026-09-04 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [OWASP PTK](https://github.com/DenisPodgurskii/pentestkit) ⭐ 237 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 -  Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* [alterx](https://github.com/projectdiscovery/alterx) ⭐ 1,001 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - Fast and customizable subdomain wordlist generator using DSL. alterx takes patterns as input and generates subdomain permutation wordlist based on that pattern.
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,010 | 🐛 487 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,763 | 🐛 862 | 🌐 Java | 📅 2026-09-10 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,466 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
* [proxify](https://github.com/projectdiscovery/proxify) ⭐ 3,068 | 🐛 5 | 🌐 Go | 📅 2026-08-31 - A versatile and portable proxy for capturing, manipulating, and replaying HTTP/HTTPS traffic on the go.
* [FoxyProxy Browser Extension](https://github.com/foxyproxy/browser-extension) ⭐ 518 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-26 - FoxyProxy is an open-source, advanced proxy management tool that completely replaces Chrome's limited proxying capabilities.

### Origin IP

* [hakoriginfinder](https://github.com/hakluke/hakoriginfinder) ⭐ 1,102 | 🐛 1 | 🌐 Go | 📅 2026-08-05 - Tool for discovering the origin host behind a reverse proxy. Useful for bypassing WAFs and other reverse proxies.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,806 | 🐛 576 | 🌐 JavaScript | 📅 2026-09-11 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,527 | 🐛 10 | 🌐 Go | 📅 2026-09-09 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [notify](https://github.com/projectdiscovery/notify) ⭐ 1,613 | 🐛 9 | 🌐 Go | 📅 2026-09-07 - Notify is a Go-based assistance package that enables you to stream the output of several tools (or read from a file) and publish it to a variety of supported platforms.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,921 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-08 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,417 | 🐛 78 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,745 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 917 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,796 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,441 | 🐛 8 | 🌐 PHP | 📅 2026-09-11 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,683 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,950 | 🐛 0 | 📅 2026-09-11 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,533 | 🐛 12 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,657 | 🐛 12 | 🌐 Go | 📅 2026-09-07 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [awesome-vulnerable-apps](https://github.com/vavkamil/awesome-vulnerable-apps) ⭐ 1,480 | 🐛 3 | 📅 2026-06-15 - Awesome Vulnerable Applications
* [mapcidr](https://github.com/projectdiscovery/mapcidr) ⭐ 1,227 | 🐛 0 | 🌐 Go | 📅 2026-09-07 - Utility program to perform multiple operations for a given subnet/CIDR ranges.
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 376 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
