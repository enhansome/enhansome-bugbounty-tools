...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,081 | 🐛 239 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,346 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,029 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool for penetration testers
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,522 | 🐛 40 | 🌐 Python | 📅 2026-08-31 - A recursive internet scanner for hackers
* [knock](https://github.com/guelfoweb/knock) ⭐ 4,181 | 🐛 71 | 🌐 Python | 📅 2026-02-19 - Knockpy is a python tool designed to enumerate subdomains on a target domain through a wordlist.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,787 | 🐛 24 | 🌐 Rust | 📅 2026-08-27 - The fastest and cross-platform subdomain enumerator, do not waste your time.
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,668 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
* [massdns](https://github.com/blechschmidt/massdns) ⭐ 3,638 | 🐛 14 | 🌐 C | 📅 2026-04-15 - A high-performance DNS stub resolver for bulk lookups and reconnaissance (subdomain enumeration)
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,854 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [scilla](https://github.com/edoardottt/scilla) ⭐ 1,264 | 🐛 7 | 🌐 Go | 📅 2026-08-24 - Information Gathering tool - DNS / Subdomains / Ports / Directories enumeration
* [domain](https://github.com/jhaddix/domain/) ⭐ 941 | 🐛 21 | 🌐 Python | 📅 2020-11-17 - enumall.py Setup script for Regon-ng
* [chaos-client](https://github.com/projectdiscovery/chaos-client) ⭐ 880 | 🐛 7 | 🌐 Go | 📅 2026-08-31 - Go client to communicate with Chaos DNS API.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,964 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,345 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,492 | 🐛 675 | 🌐 C | 📅 2026-08-31 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,216 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,835 | 🐛 29 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
* [Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived - Recovers passwords from pixelized screenshots
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,495 | 🐛 41 | 🌐 Go | 📅 2026-04-22 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,954 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,335 | 🐛 5 | 🌐 Go | 📅 2026-08-31 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,804 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,532 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,164 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-23 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [cdncheck](https://github.com/projectdiscovery/cdncheck) ⭐ 989 | 🐛 10 | 🌐 Go | 📅 2026-08-31 - cdncheck is a tool for identifying the technology associated with dns / ip network addresses.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,363 | 🐛 20 | 🌐 Go | 📅 2026-08-31 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,677 | 🐛 23 | 🌐 Python | 📅 2026-08-27 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,062 | 🐛 23 | 🌐 Go | 📅 2026-08-30 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,045 | 🐛 41 | 🌐 Rust | 📅 2026-04-15 - A fast, simple, recursive content discovery tool written in Rust.
...
* [uncover](https://github.com/projectdiscovery/uncover) ⭐ 3,043 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - uncover is a go wrapper using APIs of well known search engines to quickly discover exposed hosts on the internet.
* [gospider](https://github.com/jaeles-project/gospider) ⭐ 2,995 | 🐛 57 | 🌐 Go | 📅 2024-04-21 - Gospider - Fast web spider written in Go
...
* [gau](https://github.com/lc/gau) ⭐ 5,079 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
...
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,903 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [URLFinder](https://github.com/projectdiscovery/urlfinder) ⭐ 906 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - A high-speed tool for passively gathering URLs, optimized for efficient web asset discovery without active scanning.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,389 | 🐛 23 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery suite.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,612 | 🐛 231 | 🌐 Go | 📅 2026-08-20 -  Fast web fuzzer written in Go
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,563 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
* [IntruderPayloads](https://github.com/1N3/IntruderPayloads) ⭐ 3,973 | 🐛 4 | 🌐 BlitzBasic | 📅 2021-09-27 - A collection of Burpsuite Intruder payloads, BurpBounty payloads, fuzz lists, malicious file uploads and web pentesting methodologies and checklists.
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,321 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,336 | 🐛 74 | 🌐 Swift | 📅 2026-08-31 - A JavaScript Engine Fuzzer
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,832 | 🐛 4 | 🌐 Python | 📅 2026-08-25 - Automated All-in-One OS command injection and exploitation tool.
...
* [liffy](https://github.com/mzfr/liffy) ⭐ 983 | 🐛 1 | 🌐 Python | 📅 2026-05-19 - Local file inclusion exploitation tool
...
* [inql](https://github.com/doyensec/inql) ⭐ 1,803 | 🐛 29 | 🌐 Kotlin | 📅 2026-06-17 - InQL - A Burp Extension for GraphQL Security Testing
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,036 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [ysoserial.net](https://github.com/pwntester/ysoserial.net) ⭐ 3,784 | 🐛 11 | 🌐 C# | 📅 2026-06-11 - Deserialization payload generator for a variety of .NET formatters
...
* [razzer](https://github.com/compsec-snu/razzer) ⭐ 376 | 🐛 9 | 🌐 C | 📅 2019-07-10 - A Kernel fuzzer focusing on race bugs
...
* [smuggler](https://github.com/defparam/smuggler) ⭐ 2,098 | 🐛 19 | 🌐 Python | 📅 2024-01-02 - Smuggler - An HTTP Request Smuggling / Desync testing tool written in Python 3
...
* [SSRFmap](https://github.com/swisskyrepo/SSRFmap) ⭐ 3,610 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - Automatic SSRF fuzzer and exploitation tool
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,325 | 🐛 34 | 🌐 Python | 📅 2026-08-28 - Automatic SQL injection and database takeover tool
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,162 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,266 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [xsser](https://github.com/epsylon/xsser) ⭐ 1,462 | 🐛 0 | 🌐 Python | 📅 2026-08-30 - Cross Site "Scripter" (aka XSSer) is an automatic -framework- to detect, exploit and report XSS vulnerabilities in web-based applications.
...
* [CSPBypass](https://github.com/renniepak/CSPBypass) ⭐ 714 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 - a tool designed to help bypass restrictive Content Security Policies (CSP) and exploit XSS (Cross-Site Scripting) vulnerabilities on sites where injections are blocked by CSPs that only allow certain whitelisted domains.
...
* [XXEinjector](https://github.com/enjoiz/XXEinjector) ⭐ 1,799 | 🐛 0 | 🌐 Ruby | 📅 2024-12-01 - Tool for automatic exploitation of XXE vulnerability using direct and different out of band methods.
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,867 | 🐛 3 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
...
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,727 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,037 | 🐛 470 | 🌐 Go | 📅 2026-08-26 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,642 | 🐛 530 | 🌐 Go | 📅 2026-08-31 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
...
* [keyhacks](https://github.com/streaak/keyhacks) ⭐ 6,327 | 🐛 45 | 📅 2026-08-07 - KeyHacks shows methods to validate different API keys found on a Bug Bounty Program or a pentest.
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,756 | 🐛 14 | 🌐 Go | 📅 2026-08-31 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,420 | 🐛 163 | 🌐 Rust | 📅 2026-08-31 - Static analysis tool for GitHub Actions
* [GitTools](https://github.com/internetwache/GitTools) ⭐ 4,181 | 🐛 1 | 🌐 Shell | 📅 2026-07-15 - A repository with 3 tools for pwn'ing websites with .git repositories available
* [git-dumper](https://github.com/arthaud/git-dumper) ⭐ 2,650 | 🐛 10 | 🌐 Python | 📅 2026-08-28 - A tool to dump a git repository from a website
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,746 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a free, for non-commercial use, black box WordPress security scanner
* [joomscan](https://github.com/OWASP/joomscan) ⭐ 1,193 | 🐛 24 | 🌐 Raku | 📅 2024-09-11 - OWASP Joomla Vulnerability Scanner Project
...
* [jwt\_tool](https://github.com/ticarpi/jwt_tool) ⭐ 6,757 | 🐛 74 | 🌐 Python | 📅 2025-05-01 - A toolkit for testing, tweaking and cracking JSON Web Tokens
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,075 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - jwt-hack is tool for hacking / security testing to JWT.
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,923 | 🐛 599 | 🌐 Ruby | 📅 2026-08-31 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,952 | 🐛 105 | 🌐 Go | 📅 2026-08-31 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,712 | 🐛 858 | 🌐 Java | 📅 2026-08-27 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,895 | 🐛 98 | 🌐 JavaScript | 📅 2026-08-31 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,176 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,693 | 🐛 1 | 🌐 Perl | 📅 2026-08-28 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,541 | 🐛 10 | 🌐 Go | 📅 2026-08-08 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
...
* [Findsploit](https://github.com/1N3/Findsploit) ⭐ 1,847 | 🐛 1 | 🌐 Shell | 📅 2021-09-27 - Find exploits in local and online databases instantly
...
* [OWASP PTK](https://github.com/DenisPodgurskii/pentestkit) ⭐ 233 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-31 -  Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* [alterx](https://github.com/projectdiscovery/alterx) ⭐ 994 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - Fast and customizable subdomain wordlist generator using DSL. alterx takes patterns as input and generates subdomain permutation wordlist based on that pattern.
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,868 | 🐛 471 | 🌐 Python | 📅 2026-08-25 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,712 | 🐛 858 | 🌐 Java | 📅 2026-08-27 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,006 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
* [proxify](https://github.com/projectdiscovery/proxify) ⭐ 3,065 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - A versatile and portable proxy for capturing, manipulating, and replaying HTTP/HTTPS traffic on the go.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,706 | 🐛 551 | 🌐 JavaScript | 📅 2026-08-29 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,512 | 🐛 10 | 🌐 Go | 📅 2026-08-31 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,385 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-31 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,168 | 🐛 71 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 881 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,531 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,197 | 🐛 13 | 🌐 PHP | 📅 2026-08-31 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,659 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,928 | 🐛 0 | 📅 2026-08-31 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
...
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,639 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [awesome-vulnerable-apps](https://github.com/vavkamil/awesome-vulnerable-apps) ⭐ 1,475 | 🐛 3 | 📅 2026-06-15 - Awesome Vulnerable Applications
* [mapcidr](https://github.com/projectdiscovery/mapcidr) ⭐ 1,221 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - Utility program to perform multiple operations for a given subnet/CIDR ranges.
* [asnmap](https://github.com/projectdiscovery/asnmap) ⭐ 1,122 | 🐛 5 | 🌐 Go | 📅 2026-08-31 - Go CLI and Library for quickly mapping organization network ranges using ASN information.
* [Bypass bot detection](https://github.com/portswigger/bypass-bot-detection) ⭐ 501 | 🐛 1 | 🌐 Java | 📅 2025-09-09 - Burp Suite extension that mutates ciphers to bypass TLS-fingerprint based bot detection.
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 374 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
