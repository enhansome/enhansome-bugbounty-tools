...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,089 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,367 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,532 | 🐛 41 | 🌐 Python | 📅 2026-09-03 - A recursive internet scanner for hackers
* [knock](https://github.com/guelfoweb/knock) ⭐ 4,184 | 🐛 71 | 🌐 Python | 📅 2026-02-19 - Knockpy is a python tool designed to enumerate subdomains on a target domain through a wordlist.
...
* [shosubgo](https://github.com/incogbyte/shosubgo) ⭐ 578 | 🐛 1 | 🌐 Go | 📅 2025-09-01 - Small tool to Grab subdomains using Shodan api
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,972 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,358 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,514 | 🐛 678 | 🌐 C | 📅 2026-09-02 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,224 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,499 | 🐛 42 | 🌐 Go | 📅 2026-04-22 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,967 | 🐛 6 | 🌐 Python | 📅 2026-09-03 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [eyeballer](https://github.com/BishopFox/eyeballer) ⭐ 1,289 | 🐛 9 | 🌐 Python | 📅 2026-03-08 - Convolutional neural network for analyzing pentest screenshots
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,348 | 🐛 6 | 🌐 Go | 📅 2026-09-03 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,812 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,535 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,166 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-23 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [cdncheck](https://github.com/projectdiscovery/cdncheck) ⭐ 988 | 🐛 10 | 🌐 Go | 📅 2026-08-31 - cdncheck is a tool for identifying the technology associated with dns / ip network addresses.
* [graphw00f](https://github.com/dolevf/graphw00f) ⭐ 895 | 🐛 3 | 🌐 Python | 📅 2026-05-16 - graphw00f is GraphQL Server Engine Fingerprinting utility for software security professionals looking to learn more about what technology is behind a given GraphQL endpoint.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,382 | 🐛 35 | 🌐 Go | 📅 2026-08-31 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,686 | 🐛 24 | 🌐 Python | 📅 2026-09-03 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,071 | 🐛 23 | 🌐 Go | 📅 2026-09-03 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,051 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 - A fast, simple, recursive content discovery tool written in Rust.
...
* [uncover](https://github.com/projectdiscovery/uncover) ⭐ 3,047 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - uncover is a go wrapper using APIs of well known search engines to quickly discover exposed hosts on the internet.
...
* [gau](https://github.com/lc/gau) ⭐ 5,082 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
* [waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,551 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all the URLs that the Wayback Machine knows about for a domain
...
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,908 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
* [xnLinkFinder](https://github.com/xnl-h4ck3r/xnLinkFinder) ⭐ 1,589 | 🐛 4 | 🌐 Python | 📅 2026-03-08 -  A python tool used to discover endpoints, potential parameters, and a target specific wordlist for a given target
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,396 | 🐛 23 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery suite.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,633 | 🐛 233 | 🌐 Go | 📅 2026-08-20 -  Fast web fuzzer written in Go
...
* [IntruderPayloads](https://github.com/1N3/IntruderPayloads) ⭐ 3,975 | 🐛 4 | 🌐 BlitzBasic | 📅 2021-09-27 - A collection of Burpsuite Intruder payloads, BurpBounty payloads, fuzz lists, malicious file uploads and web pentesting methodologies and checklists.
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,323 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,339 | 🐛 74 | 🌐 Swift | 📅 2026-09-02 - A JavaScript Engine Fuzzer
...
* [bbscope](https://github.com/sw33tLie/bbscope) ⭐ 1,433 | 🐛 17 | 🌐 Go | 📅 2026-09-02 - Scope aggregation tool for HackerOne, Bugcrowd, Intigriti, YesWeHack, Immunefi
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,832 | 🐛 5 | 🌐 Python | 📅 2026-09-03 - Automated All-in-One OS command injection and exploitation tool.
...
* [LFISuite](https://github.com/D35m0nd142/LFISuite) ⭐ 1,963 | 🐛 28 | 🌐 Python | 📅 2022-04-13 - Totally Automatic LFI Exploiter (+ Reverse Shell) and Scanner
...
* [clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,513 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Obtain GraphQL API schema despite disabled introspection!
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,042 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [ysoserial.net](https://github.com/pwntester/ysoserial.net) ⭐ 3,785 | 🐛 11 | 🌐 C# | 📅 2026-06-11 - Deserialization payload generator for a variety of .NET formatters
...
* [Oralyzer](https://github.com/r0075h3ll/Oralyzer) ⭐ 823 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Open Redirection Analyzer
* [OpenRedireX](https://github.com/devanshbatham/OpenRedireX) ⭐ 802 | 🐛 5 | 🌐 Python | 📅 2024-07-01 - A Fuzzer for OpenRedirect issues
* [Injectus](https://github.com/BountyStrike/Injectus) ⚠️ Archived - CRLF and open redirect fuzzer
...
* [smuggler](https://github.com/defparam/smuggler) ⭐ 2,099 | 🐛 19 | 🌐 Python | 📅 2024-01-02 - Smuggler - An HTTP Request Smuggling / Desync testing tool written in Python 3
...
* [SSRFmap](https://github.com/swisskyrepo/SSRFmap) ⭐ 3,615 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - Automatic SSRF fuzzer and exploitation tool
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,353 | 🐛 33 | 🌐 Python | 📅 2026-09-02 - Automatic SQL injection and database takeover tool
...
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,271 | 🐛 0 | 🌐 Rust | 📅 2026-09-03 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [CSPBypass](https://github.com/renniepak/CSPBypass) ⭐ 715 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 - a tool designed to help bypass restrictive Content Security Policies (CSP) and exploit XSS (Cross-Site Scripting) vulnerabilities on sites where injections are blocked by CSPs that only allow certain whitelisted domains.
...
* [XXEinjector](https://github.com/enjoiz/XXEinjector) ⭐ 1,800 | 🐛 0 | 🌐 Ruby | 📅 2024-12-01 - Tool for automatic exploitation of XXE vulnerability using direct and different out of band methods.
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,871 | 🐛 4 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,225 | 🐛 49 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,729 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
* [patator](https://github.com/lanjelot/patator) ⭐ 3,929 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design and a flexible usage.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,088 | 🐛 474 | 🌐 Go | 📅 2026-08-26 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,673 | 🐛 537 | 🌐 Go | 📅 2026-09-03 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,759 | 🐛 14 | 🌐 Go | 📅 2026-08-31 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,382 | 🐛 11 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,438 | 🐛 165 | 🌐 Rust | 📅 2026-09-03 - Static analysis tool for GitHub Actions
...
* [jwt\_tool](https://github.com/ticarpi/jwt_tool) ⭐ 6,760 | 🐛 74 | 🌐 Python | 📅 2025-05-01 - A toolkit for testing, tweaking and cracking JSON Web Tokens
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,076 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - jwt-hack is tool for hacking / security testing to JWT.
...
* [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) ⭐ 5,795 | 🐛 215 | 🌐 Python | 📅 2025-02-08 - "Can I take over XYZ?" — a list of services and how to claim (sub)domains with dangling DNS records.
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,931 | 🐛 607 | 🌐 Ruby | 📅 2026-09-03 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,995 | 🐛 107 | 🌐 Go | 📅 2026-09-03 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,727 | 🐛 859 | 🌐 Java | 📅 2026-09-03 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,910 | 🐛 128 | 🌐 JavaScript | 📅 2026-09-03 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,194 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,699 | 🐛 1 | 🌐 Perl | 📅 2026-08-28 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,542 | 🐛 10 | 🌐 Go | 📅 2026-08-08 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,166 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-23 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,068 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
* [OWASP PTK](https://github.com/DenisPodgurskii/pentestkit) ⭐ 235 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 -  Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* [alterx](https://github.com/projectdiscovery/alterx) ⭐ 997 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - Fast and customizable subdomain wordlist generator using DSL. alterx takes patterns as input and generates subdomain permutation wordlist based on that pattern.
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,900 | 🐛 480 | 🌐 Python | 📅 2026-09-01 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,727 | 🐛 859 | 🌐 Java | 📅 2026-09-03 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,012 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
...
* [FoxyProxy Browser Extension](https://github.com/foxyproxy/browser-extension) ⭐ 516 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-26 - FoxyProxy is an open-source, advanced proxy management tool that completely replaces Chrome's limited proxying capabilities.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,722 | 🐛 556 | 🌐 JavaScript | 📅 2026-09-03 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,673 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-03 - Fully autonomous AI hacker to find actual exploits in your web apps.
...
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,688 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 889 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,600 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,251 | 🐛 13 | 🌐 PHP | 📅 2026-09-03 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,670 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,933 | 🐛 0 | 📅 2026-09-03 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
...
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,644 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 375 | 🐛 2 | 🌐 Go | 📅 2026-09-03 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
