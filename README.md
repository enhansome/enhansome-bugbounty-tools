...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,084 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,361 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,030 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool for penetration testers
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,527 | 🐛 39 | 🌐 Python | 📅 2026-09-02 - A recursive internet scanner for hackers
* [knock](https://github.com/guelfoweb/knock) ⭐ 4,183 | 🐛 71 | 🌐 Python | 📅 2026-02-19 - Knockpy is a python tool designed to enumerate subdomains on a target domain through a wordlist.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,788 | 🐛 24 | 🌐 Rust | 📅 2026-08-27 - The fastest and cross-platform subdomain enumerator, do not waste your time.
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,670 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
* [massdns](https://github.com/blechschmidt/massdns) ⭐ 3,641 | 🐛 14 | 🌐 C | 📅 2026-04-15 - A high-performance DNS stub resolver for bulk lookups and reconnaissance (subdomain enumeration)
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,856 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [puredns](https://github.com/d3mondev/puredns) ⭐ 2,238 | 🐛 16 | 🌐 Go | 📅 2026-02-23 - Fast domain resolver and subdomain bruteforcing with accurate wildcard filtering with wildcard(\*)
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,669 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [VHostScan](https://github.com/codingo/VHostScan) ⭐ 1,308 | 🐛 1 | 🌐 Python | 📅 2025-08-18 - A virtual host scanner that performs reverse lookups
* [dnscan](https://github.com/rbsec/dnscan) ⭐ 1,278 | 🐛 6 | 🌐 Python | 📅 2024-12-17 - dnscan is a python wordlist-based DNS subdomain scanner.
* [scilla](https://github.com/edoardottt/scilla) ⭐ 1,264 | 🐛 8 | 🌐 Go | 📅 2026-08-31 - Information Gathering tool - DNS / Subdomains / Ports / Directories enumeration
...
* [csprecon](https://github.com/edoardottt/csprecon) ⭐ 524 | 🐛 0 | 🌐 Go | 📅 2026-09-02 - Discover new target domains using Content Security Policy
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,965 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,352 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,503 | 🐛 677 | 🌐 C | 📅 2026-09-02 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,223 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,837 | 🐛 29 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
* [Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived - Recovers passwords from pixelized screenshots
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,497 | 🐛 41 | 🌐 Go | 📅 2026-04-22 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,961 | 🐛 5 | 🌐 Python | 📅 2026-09-02 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,342 | 🐛 5 | 🌐 Go | 📅 2026-09-02 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,808 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
...
* [tlsx](https://github.com/projectdiscovery/tlsx) ⭐ 1,135 | 🐛 8 | 🌐 Go | 📅 2026-09-02 - A fast and configurable TLS grabber focused on TLS based data collection and analysis.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,373 | 🐛 30 | 🌐 Go | 📅 2026-08-31 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,683 | 🐛 24 | 🌐 Python | 📅 2026-08-27 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,066 | 🐛 23 | 🌐 Go | 📅 2026-08-30 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,050 | 🐛 42 | 🌐 Rust | 📅 2026-09-02 - A fast, simple, recursive content discovery tool written in Rust.
* [hakrawler](https://github.com/hakluke/hakrawler) ⭐ 5,117 | 🐛 9 | 🌐 Go | 📅 2026-08-05 - Simple, fast web crawler designed for easy, quick discovery of endpoints and assets within a web application
* [kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,251 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - Fast API endpoint bruteforcer and content discovery tool for modern web applications.
* [uncover](https://github.com/projectdiscovery/uncover) ⭐ 3,044 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - uncover is a go wrapper using APIs of well known search engines to quickly discover exposed hosts on the internet.
...
* [gau](https://github.com/lc/gau) ⭐ 5,080 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
* [waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,549 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all the URLs that the Wayback Machine knows about for a domain
...
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,907 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
* [xnLinkFinder](https://github.com/xnl-h4ck3r/xnLinkFinder) ⭐ 1,588 | 🐛 4 | 🌐 Python | 📅 2026-03-08 -  A python tool used to discover endpoints, potential parameters, and a target specific wordlist for a given target
* [URLFinder](https://github.com/projectdiscovery/urlfinder) ⭐ 907 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - A high-speed tool for passively gathering URLs, optimized for efficient web asset discovery without active scanning.
...
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,166 | 🐛 37 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of Web Archives.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,622 | 🐛 233 | 🌐 Go | 📅 2026-08-20 -  Fast web fuzzer written in Go
...
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,339 | 🐛 74 | 🌐 Swift | 📅 2026-08-31 - A JavaScript Engine Fuzzer
...
* [bbscope](https://github.com/sw33tLie/bbscope) ⭐ 1,433 | 🐛 23 | 🌐 Go | 📅 2026-07-06 - Scope aggregation tool for HackerOne, Bugcrowd, Intigriti, YesWeHack, Immunefi
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,830 | 🐛 4 | 🌐 Python | 📅 2026-09-02 - Automated All-in-One OS command injection and exploitation tool.
...
* [crlfuzz](https://github.com/dwisiswant0/crlfuzz) ⭐ 1,561 | 🐛 1 | 🌐 Go | 📅 2026-08-28 - A fast tool to scan CRLF vulnerability written in Go
...
* [inql](https://github.com/doyensec/inql) ⭐ 1,804 | 🐛 30 | 🌐 Kotlin | 📅 2026-06-17 - InQL - A Burp Extension for GraphQL Security Testing
...
* [clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,512 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Obtain GraphQL API schema despite disabled introspection!
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,041 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
* [phpggc](https://github.com/ambionics/phpggc) ⭐ 3,880 | 🐛 21 | 🌐 PHP | 📅 2025-09-29 - PHPGGC is a library of PHP unserialize() payloads along with a tool to generate them, from command line or programmatically.
...
* [Oralyzer](https://github.com/r0075h3ll/Oralyzer) ⭐ 822 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Open Redirection Analyzer
* [OpenRedireX](https://github.com/devanshbatham/OpenRedireX) ⭐ 801 | 🐛 5 | 🌐 Python | 📅 2024-07-01 - A Fuzzer for OpenRedirect issues
* [Injectus](https://github.com/BountyStrike/Injectus) ⚠️ Archived - CRLF and open redirect fuzzer
...
* [tiscripts](https://github.com/defparam/tiscripts) ⭐ 232 | 🐛 0 | 🌐 Python | 📅 2020-06-11 - These scripts I use to create Request Smuggling Desync payloads for CLTE and TECL style attacks.
* [smugglex](github.com/hahwul/smugglex) - Rust-powered HTTP Request Smuggling Scanner.

### Server Side Request Forgery

* [SSRFmap](https://github.com/swisskyrepo/SSRFmap) ⭐ 3,613 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - Automatic SSRF fuzzer and exploitation tool
* [Gopherus](https://github.com/tarunkant/Gopherus) ⭐ 3,412 | 🐛 11 | 🌐 Python | 📅 2023-04-18 - This tool generates gopher link for exploiting SSRF and gaining RCE in various servers
* [singularity](https://github.com/nccgroup/singularity) ⭐ 1,316 | 🐛 17 | 🌐 JavaScript | 📅 2026-07-21 - A DNS rebinding attack framework.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,340 | 🐛 32 | 🌐 Python | 📅 2026-09-02 - Automatic SQL injection and database takeover tool
* [ghauri](https://github.com/r0oth3x49/ghauri) ⭐ 4,075 | 🐛 25 | 🌐 Python | 📅 2025-10-04 - An advanced cross-platform tool that automates the process of detecting and exploiting SQL injection security flaws
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,166 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,268 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
* [ezXSS](https://github.com/ssl/ezXSS) ⭐ 2,333 | 🐛 5 | 🌐 PHP | 📅 2026-07-08 - ezXSS is an easy way for penetration testers and bug bounty hunters to test (blind) Cross Site Scripting.
...
* [xsser](https://github.com/epsylon/xsser) ⭐ 1,461 | 🐛 0 | 🌐 Python | 📅 2026-08-30 - Cross Site "Scripter" (aka XSSer) is an automatic -framework- to detect, exploit and report XSS vulnerabilities in web-based applications.
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,625 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - Automatic SSTI detection tool with interactive interface
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,869 | 🐛 4 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
...
* [Forbidden Buster](https://github.com/Sn1r/Forbidden-Buster) ⭐ 253 | 🐛 0 | 🌐 Python | 📅 2024-08-31 - A tool designed to automate various techniques in order to bypass HTTP 401 and 403 response codes and gain access to unauthorized areas in the system.
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,219 | 🐛 49 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
...
* [patator](https://github.com/lanjelot/patator) ⭐ 3,927 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design and a flexible usage.
* [BruteX](https://github.com/1N3/BruteX) ⭐ 2,301 | 🐛 10 | 🌐 Shell | 📅 2024-08-18 - Automatically brute force all services running on a target.
* [changeme](https://github.com/ztgrace/changeme) ⭐ 1,517 | 🐛 16 | 🌐 Python | 📅 2025-07-08 - A default credential scanner.

### Secrets

* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,067 | 🐛 475 | 🌐 Go | 📅 2026-08-26 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,659 | 🐛 534 | 🌐 Go | 📅 2026-09-01 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,387 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,758 | 🐛 14 | 🌐 Go | 📅 2026-08-31 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
* [SecretFinder](https://github.com/m4ll0k/SecretFinder) ⭐ 2,502 | 🐛 49 | 🌐 Python | 📅 2024-05-26 - A python script for finding sensitive data (apikeys, accesstoken,jwt,..) and search anything on javascript files.
...
* [GitHound](https://github.com/tillson/git-hound) ⭐ 1,454 | 🐛 4 | 🌐 Go | 📅 2026-02-10 - Recon tool leveraging Code Search API. Scans for exposed API keys across all of GitHub, not just known repos and orgs. Support for GitHub dorks.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,434 | 🐛 165 | 🌐 Rust | 📅 2026-09-02 - Static analysis tool for GitHub Actions
* [GitTools](https://github.com/internetwache/GitTools) ⭐ 4,182 | 🐛 1 | 🌐 Shell | 📅 2026-07-15 - A repository with 3 tools for pwn'ing websites with .git repositories available
* [git-dumper](https://github.com/arthaud/git-dumper) ⭐ 2,652 | 🐛 10 | 🌐 Python | 📅 2026-08-28 - A tool to dump a git repository from a website
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,752 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a free, for non-commercial use, black box WordPress security scanner
* [joomscan](https://github.com/OWASP/joomscan) ⭐ 1,196 | 🐛 24 | 🌐 Raku | 📅 2024-09-11 - OWASP Joomla Vulnerability Scanner Project
...
* [aemhacker](https://github.com/0ang3el/aem-hacker) ⭐ 812 | 🐛 15 | 🌐 Python | 📅 2024-07-28 - Tools to identify vulnerable Adobe Experience Manager (AEM) webapps.
...
* [wprecon](https://github.com/blackcrw/wprecon) ⭐ 21 | 🐛 0 | 🌐 Go | 📅 2026-06-05 - Wordpress Recon

### JSON Web Token

* [jwt\_tool](https://github.com/ticarpi/jwt_tool) ⭐ 6,758 | 🐛 74 | 🌐 Python | 📅 2025-05-01 - A toolkit for testing, tweaking and cracking JSON Web Tokens
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,075 | 🐛 0 | 🌐 Rust | 📅 2026-09-02 - jwt-hack is tool for hacking / security testing to JWT.
...
* [postMessage-tracker](https://github.com/fransr/postMessage-tracker) ⭐ 1,336 | 🐛 11 | 🌐 JavaScript | 📅 2024-01-26 - A Chrome Extension to track postMessage usage (url, domain and stack) both by logging using CORS and also visually as an extension-icon
...
* [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) ⭐ 5,794 | 🐛 215 | 🌐 Python | 📅 2025-02-08 - "Can I take over XYZ?" — a list of services and how to claim (sub)domains with dangling DNS records.
* [dnsReaper](https://github.com/punk-security/dnsReaper) ⭐ 2,218 | 🐛 32 | 🌐 Python | 📅 2025-10-06 - DNS Reaper is yet another sub-domain takeover tool, but with an emphasis on accuracy, speed and the number of signatures in our arsenal!
* [subjack](https://github.com/haccer/subjack) ⭐ 2,111 | 🐛 3 | 🌐 Go | 📅 2026-07-03 - Subdomain Takeover tool written in Go
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,931 | 🐛 604 | 🌐 Ruby | 📅 2026-09-02 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,979 | 🐛 109 | 🌐 Go | 📅 2026-09-01 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,719 | 🐛 859 | 🌐 Java | 📅 2026-09-01 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,901 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-02 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,185 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,697 | 🐛 1 | 🌐 Perl | 📅 2026-08-28 - Nikto web server scanner
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,625 | 🐛 13 | 🌐 Python | 📅 2026-08-25 -  SSTImap is a penetration testing software that can check websites for Code Injection and Server-Side Template Injection vulnerabilities and exploit them, giving access to the operating system itself.
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,059 | 🐛 6 | 🌐 Go | 📅 2026-08-30 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,052 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
* [OWASP PTK](https://github.com/DenisPodgurskii/pentestkit) ⭐ 233 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 -  Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* [alterx](https://github.com/projectdiscovery/alterx) ⭐ 996 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - Fast and customizable subdomain wordlist generator using DSL. alterx takes patterns as input and generates subdomain permutation wordlist based on that pattern.
* [gotator](https://github.com/Josue87/gotator) ⭐ 532 | 🐛 7 | 🌐 Go | 📅 2022-07-17 - Gotator is a tool to generate DNS wordlists through permutations.
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,889 | 🐛 479 | 🌐 Python | 📅 2026-09-01 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,719 | 🐛 859 | 🌐 Java | 📅 2026-09-01 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,007 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
* [proxify](https://github.com/projectdiscovery/proxify) ⭐ 3,064 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - A versatile and portable proxy for capturing, manipulating, and replaying HTTP/HTTPS traffic on the go.
* [FoxyProxy Browser Extension](https://github.com/foxyproxy/browser-extension) ⭐ 516 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-26 - FoxyProxy is an open-source, advanced proxy management tool that completely replaces Chrome's limited proxying capabilities.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,714 | 🐛 553 | 🌐 JavaScript | 📅 2026-09-01 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,514 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [uro](https://github.com/s0md3v/uro) ⭐ 1,589 | 🐛 3 | 🌐 Python | 📅 2025-02-23 -  declutters url lists for crawling/pentesting
* [unfurl](https://github.com/tomnomnom/unfurl) ⭐ 1,340 | 🐛 14 | 🌐 Go | 📅 2023-08-12 -  Pull out bits of URLs provided on stdin
* [qsreplace](https://github.com/tomnomnom/qsreplace) ⭐ 883 | 🐛 16 | 🌐 Go | 📅 2022-11-23 -  Accept URLs on stdin, replace all query string values with a user-supplied value

### AI Agents

* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,595 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-02 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,187 | 🐛 73 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,666 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 887 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,579 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,231 | 🐛 13 | 🌐 PHP | 📅 2026-09-02 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,668 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,932 | 🐛 0 | 📅 2026-09-02 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,527 | 🐛 14 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,641 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [BigBountyRecon](https://github.com/Viralmaniar/BigBountyRecon) ⭐ 1,566 | 🐛 9 | 🌐 C# | 📅 2021-01-29 - BigBountyRecon tool utilises 58 different techniques using various Google dorks and open source tools to expedite the process of initial reconnaissance on the target organisation.
* [awesome-vulnerable-apps](https://github.com/vavkamil/awesome-vulnerable-apps) ⭐ 1,477 | 🐛 3 | 📅 2026-06-15 - Awesome Vulnerable Applications
* [mapcidr](https://github.com/projectdiscovery/mapcidr) ⭐ 1,222 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Utility program to perform multiple operations for a given subnet/CIDR ranges.
* [asnmap](https://github.com/projectdiscovery/asnmap) ⭐ 1,125 | 🐛 5 | 🌐 Go | 📅 2026-08-31 - Go CLI and Library for quickly mapping organization network ranges using ASN information.
...
* [bountyplz](https://github.com/fransr/bountyplz) ⭐ 465 | 🐛 5 | 🌐 Shell | 📅 2019-05-10 - Automated security reporting from markdown templates (HackerOne and Bugcrowd are currently the platforms supported)
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 374 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
