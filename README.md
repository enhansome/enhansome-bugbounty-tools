...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,082 | 🐛 239 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,352 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,523 | 🐛 39 | 🌐 Python | 📅 2026-09-01 - A recursive internet scanner for hackers
...
* [massdns](https://github.com/blechschmidt/massdns) ⭐ 3,639 | 🐛 14 | 🌐 C | 📅 2026-04-15 - A high-performance DNS stub resolver for bulk lookups and reconnaissance (subdomain enumeration)
...
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,667 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [csprecon](https://github.com/edoardottt/csprecon) ⭐ 524 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - Discover new target domains using Content Security Policy
...
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,346 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,495 | 🐛 676 | 🌐 C | 📅 2026-08-31 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,220 | 🐛 0 | 🌐 Go | 📅 2026-08-31 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 1,960 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,337 | 🐛 3 | 🌐 Go | 📅 2026-09-01 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,803 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,529 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,368 | 🐛 25 | 🌐 Go | 📅 2026-08-31 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,678 | 🐛 23 | 🌐 Python | 📅 2026-08-27 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,066 | 🐛 23 | 🌐 Go | 📅 2026-08-30 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,050 | 🐛 41 | 🌐 Rust | 📅 2026-04-15 - A fast, simple, recursive content discovery tool written in Rust.
...
* [waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,548 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all the URLs that the Wayback Machine knows about for a domain
...
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,904 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [URLFinder](https://github.com/projectdiscovery/urlfinder) ⭐ 906 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - A high-speed tool for passively gathering URLs, optimized for efficient web asset discovery without active scanning.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,393 | 🐛 23 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery suite.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,163 | 🐛 37 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of Web Archives.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,619 | 🐛 232 | 🌐 Go | 📅 2026-08-20 -  Fast web fuzzer written in Go
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,568 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
...
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,337 | 🐛 74 | 🌐 Swift | 📅 2026-08-31 - A JavaScript Engine Fuzzer
...
* [bbscope](https://github.com/sw33tLie/bbscope) ⭐ 1,432 | 🐛 23 | 🌐 Go | 📅 2026-07-06 - Scope aggregation tool for HackerOne, Bugcrowd, Intigriti, YesWeHack, Immunefi
...
* [Corsy](https://github.com/s0md3v/Corsy) ⭐ 1,536 | 🐛 13 | 🌐 Python | 📅 2022-09-17 - CORS Misconfiguration Scanner
...
* [crlfuzz](https://github.com/dwisiswant0/crlfuzz) ⭐ 1,561 | 🐛 2 | 🌐 Go | 📅 2026-08-28 - A fast tool to scan CRLF vulnerability written in Go
...
* [inql](https://github.com/doyensec/inql) ⭐ 1,804 | 🐛 29 | 🌐 Kotlin | 📅 2026-06-17 - InQL - A Burp Extension for GraphQL Security Testing
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,039 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [Oralyzer](https://github.com/r0075h3ll/Oralyzer) ⭐ 821 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Open Redirection Analyzer
* [OpenRedireX](https://github.com/devanshbatham/OpenRedireX) ⭐ 800 | 🐛 5 | 🌐 Python | 📅 2024-07-01 - A Fuzzer for OpenRedirect issues
* [Injectus](https://github.com/BountyStrike/Injectus) ⚠️ Archived - CRLF and open redirect fuzzer
...
* [smuggler](https://github.com/defparam/smuggler) ⭐ 2,097 | 🐛 19 | 🌐 Python | 📅 2024-01-02 - Smuggler - An HTTP Request Smuggling / Desync testing tool written in Python 3
...
* [ghauri](https://github.com/r0oth3x49/ghauri) ⭐ 4,073 | 🐛 25 | 🌐 Python | 📅 2025-10-04 - An advanced cross-platform tool that automates the process of detecting and exploiting SQL injection security flaws
...
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,267 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,868 | 🐛 3 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,217 | 🐛 49 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,053 | 🐛 472 | 🌐 Go | 📅 2026-08-26 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,648 | 🐛 532 | 🌐 Go | 📅 2026-09-01 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
...
* [keyhacks](https://github.com/streaak/keyhacks) ⭐ 6,328 | 🐛 45 | 📅 2026-08-07 - KeyHacks shows methods to validate different API keys found on a Bug Bounty Program or a pentest.
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,757 | 🐛 14 | 🌐 Go | 📅 2026-08-31 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,425 | 🐛 163 | 🌐 Rust | 📅 2026-08-31 - Static analysis tool for GitHub Actions
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,748 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) ⭐ 5,792 | 🐛 215 | 🌐 Python | 📅 2025-02-08 - "Can I take over XYZ?" — a list of services and how to claim (sub)domains with dangling DNS records.
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,926 | 🐛 605 | 🌐 Ruby | 📅 2026-08-31 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,968 | 🐛 108 | 🌐 Go | 📅 2026-09-01 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,715 | 🐛 859 | 🌐 Java | 📅 2026-09-01 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,897 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-01 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,181 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,695 | 🐛 1 | 🌐 Perl | 📅 2026-08-28 - Nikto web server scanner
...
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,057 | 🐛 6 | 🌐 Go | 📅 2026-08-30 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,051 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
* [alterx](https://github.com/projectdiscovery/alterx) ⭐ 995 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - Fast and customizable subdomain wordlist generator using DSL. alterx takes patterns as input and generates subdomain permutation wordlist based on that pattern.
...
* [FoxyProxy Browser Extension](https://github.com/foxyproxy/browser-extension) ⭐ 515 | 🐛 21 | 🌐 JavaScript | 📅 2026-08-26 - FoxyProxy is an open-source, advanced proxy management tool that completely replaces Chrome's limited proxying capabilities.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,712 | 🐛 553 | 🌐 JavaScript | 📅 2026-09-01 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,513 | 🐛 10 | 🌐 Go | 📅 2026-08-31 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
* [gf](https://github.com/tomnomnom/gf) ⭐ 2,137 | 🐛 55 | 🌐 Go | 📅 2024-06-08 -  A wrapper around grep, to help you grep for things
* [anew](https://github.com/tomnomnom/anew) ⭐ 1,657 | 🐛 8 | 🌐 Go | 📅 2024-01-12 -  A tool for adding new lines to files, skipping duplicates
* [notify](https://github.com/projectdiscovery/notify) ⭐ 1,610 | 🐛 8 | 🌐 Go | 📅 2026-08-31 - Notify is a Go-based assistance package that enables you to stream the output of several tools (or read from a file) and publish it to a variety of supported platforms.
* [uro](https://github.com/s0md3v/uro) ⭐ 1,588 | 🐛 3 | 🌐 Python | 📅 2025-02-23 -  declutters url lists for crawling/pentesting
* [unfurl](https://github.com/tomnomnom/unfurl) ⭐ 1,339 | 🐛 14 | 🌐 Go | 📅 2023-08-12 -  Pull out bits of URLs provided on stdin
* [qsreplace](https://github.com/tomnomnom/qsreplace) ⭐ 882 | 🐛 16 | 🌐 Go | 📅 2022-11-23 -  Accept URLs on stdin, replace all query string values with a user-supplied value

### AI Agents

* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,487 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-31 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,178 | 🐛 72 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 885 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,554 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,211 | 🐛 13 | 🌐 PHP | 📅 2026-09-01 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,663 | 🐛 0 | 🌐 Makefile | 📅 2026-08-21 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,930 | 🐛 0 | 📅 2026-09-01 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
...
* [awesome-vulnerable-apps](https://github.com/vavkamil/awesome-vulnerable-apps) ⭐ 1,476 | 🐛 3 | 📅 2026-06-15 - Awesome Vulnerable Applications
...
* [asnmap](https://github.com/projectdiscovery/asnmap) ⭐ 1,123 | 🐛 5 | 🌐 Go | 📅 2026-08-31 - Go CLI and Library for quickly mapping organization network ranges using ASN information.
