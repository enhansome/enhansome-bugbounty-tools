...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,137 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,413 | 🐛 51 | 🌐 Go | 📅 2026-09-09 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,039 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Fast subdomains enumeration tool for penetration testers
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,562 | 🐛 48 | 🌐 Python | 📅 2026-09-07 - A recursive internet scanner for hackers
* [knock](https://github.com/guelfoweb/knock) ⭐ 4,195 | 🐛 72 | 🌐 Python | 📅 2026-02-19 - Knockpy is a python tool designed to enumerate subdomains on a target domain through a wordlist.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,791 | 🐛 2 | 🌐 Rust | 📅 2026-09-07 - The fastest and cross-platform subdomain enumerator, do not waste your time.
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,673 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,865 | 🐛 19 | 🌐 Go | 📅 2026-09-08 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,996 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,392 | 🐛 62 | 🌐 Rust | 📅 2026-09-09 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,555 | 🐛 685 | 🌐 C | 📅 2026-09-06 - Nmap - the Network Mapper. Github mirror of official SVN repository.
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,844 | 🐛 30 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
* [Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived - Recovers passwords from pixelized screenshots
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,502 | 🐛 43 | 🌐 Go | 📅 2026-04-22 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,007 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,382 | 🐛 61 | 🌐 Go | 📅 2026-09-09 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,830 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,544 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,170 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-09 - scanner detecting the use of JavaScript libraries with known vulnerabilities
* [webanalyze](https://github.com/rverton/webanalyze) ⭐ 1,174 | 🐛 4 | 🌐 Go | 📅 2026-08-28 - Port of Wappalyzer (uncovers technologies used on websites) to automate mass scanning.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,449 | 🐛 26 | 🌐 Go | 📅 2026-09-10 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,712 | 🐛 23 | 🌐 Python | 📅 2026-09-10 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,102 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,061 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,258 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - Fast API endpoint bruteforcer and content discovery tool for modern web applications.
...
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,919 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [getJS](https://github.com/003random/getJS) ⭐ 894 | 🐛 1 | 🌐 Go | 📅 2026-08-29 -  A tool to fastly get all javascript sources/files
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,662 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,574 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
...
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,342 | 🐛 74 | 🌐 Swift | 📅 2026-09-09 - A JavaScript Engine Fuzzer
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,838 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - Automated All-in-One OS command injection and exploitation tool.
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,049 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,406 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - Automatic SQL injection and database takeover tool
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,174 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,289 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,638 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - Automatic SSTI detection tool with interactive interface
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,208 | 🐛 473 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,747 | 🐛 554 | 🌐 Go | 📅 2026-09-10 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,390 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
* [keyhacks](https://github.com/streaak/keyhacks) ⭐ 6,335 | 🐛 45 | 📅 2026-08-07 - KeyHacks shows methods to validate different API keys found on a Bug Bounty Program or a pentest.
...
* [shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,979 | 🐛 33 | 🌐 JavaScript | 📅 2025-02-28 - Ah shhgit! Find GitHub secrets in real time
...
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,393 | 🐛 12 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 708 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - A Chrome extension that passively scans web pages for API keys, tokens, and secrets using 80+ regex patterns and Shannon entropy analysis across 10 attack surfaces.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,474 | 🐛 165 | 🌐 Rust | 📅 2026-09-09 - Static analysis tool for GitHub Actions
...
* [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) ⭐ 5,805 | 🐛 215 | 🌐 Python | 📅 2025-02-08 - "Can I take over XYZ?" — a list of services and how to claim (sub)domains with dangling DNS records.
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,974 | 🐛 608 | 🌐 Ruby | 📅 2026-09-09 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,102 | 🐛 108 | 🌐 Go | 📅 2026-09-10 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,757 | 🐛 860 | 🌐 Java | 📅 2026-09-10 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,947 | 🐛 107 | 🌐 JavaScript | 📅 2026-09-10 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,222 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,722 | 🐛 1 | 🌐 Perl | 📅 2026-09-08 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,556 | 🐛 11 | 🌐 Go | 📅 2026-08-08 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,170 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-09 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,638 | 🐛 13 | 🌐 Python | 📅 2026-08-25 -  SSTImap is a penetration testing software that can check websites for Code Injection and Server-Side Template Injection vulnerabilities and exploit them, giving access to the operating system itself.
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,084 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,067 | 🐛 6 | 🌐 Go | 📅 2026-09-04 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,988 | 🐛 485 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,757 | 🐛 860 | 🌐 Java | 📅 2026-09-10 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,465 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,801 | 🐛 564 | 🌐 JavaScript | 📅 2026-09-09 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,526 | 🐛 10 | 🌐 Go | 📅 2026-09-09 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,895 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-08 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,382 | 🐛 77 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,736 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 913 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,779 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,419 | 🐛 8 | 🌐 PHP | 📅 2026-09-10 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,680 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,949 | 🐛 0 | 📅 2026-09-10 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,532 | 🐛 12 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
