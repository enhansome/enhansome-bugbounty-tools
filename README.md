...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,206 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,489 | 🐛 5 | 🌐 Go | 📅 2026-09-23 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,616 | 🐛 51 | 🌐 Python | 📅 2026-09-23 - A recursive internet scanner for hackers
...
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,684 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
...
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,670 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [chaos-client](https://github.com/projectdiscovery/chaos-client) ⭐ 884 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - Go client to communicate with Chaos DNS API.
...
* [csprecon](https://github.com/edoardottt/csprecon) ⭐ 528 | 🐛 3 | 🌐 Go | 📅 2026-09-21 - Discover new target domains using Content Security Policy
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,032 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,443 | 🐛 54 | 🌐 Rust | 📅 2026-09-23 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,655 | 🐛 701 | 🌐 C | 📅 2026-09-22 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,263 | 🐛 1 | 🌐 Go | 📅 2026-09-21 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,962 | 🐛 3 | 🌐 Python | 📅 2026-09-23 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [eyeballer](https://github.com/BishopFox/eyeballer) ⭐ 1,292 | 🐛 9 | 🌐 Python | 📅 2026-03-08 - Convolutional neural network for analyzing pentest screenshots
...
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,850 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,554 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
...
* [webanalyze](https://github.com/rverton/webanalyze) ⭐ 1,176 | 🐛 4 | 🌐 Go | 📅 2026-09-19 - Port of Wappalyzer (uncovers technologies used on websites) to automate mass scanning.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,550 | 🐛 22 | 🌐 Go | 📅 2026-09-23 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,753 | 🐛 24 | 🌐 Python | 📅 2026-09-23 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,150 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,080 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [uncover](https://github.com/projectdiscovery/uncover) ⭐ 3,061 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - uncover is a go wrapper using APIs of well known search engines to quickly discover exposed hosts on the internet.
...
* [URLFinder](https://github.com/projectdiscovery/urlfinder) ⭐ 912 | 🐛 2 | 🌐 Go | 📅 2026-09-14 - A high-speed tool for passively gathering URLs, optimized for efficient web asset discovery without active scanning.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,399 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery suite.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,174 | 🐛 39 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of Web Archives.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,706 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
* [fuzzdb](https://github.com/fuzzdb-project/fuzzdb) ⭐ 8,991 | 🐛 15 | 🌐 PHP | 📅 2023-11-10 - Dictionary of attack patterns and primitives for black-box application fault injection and resource discovery.
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,583 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
...
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,330 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,346 | 🐛 74 | 🌐 Swift | 📅 2026-09-23 - A JavaScript Engine Fuzzer
...
* [clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,528 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Obtain GraphQL API schema despite disabled introspection!
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,064 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [ysoserial.net](https://github.com/pwntester/ysoserial.net) ⭐ 3,792 | 🐛 11 | 🌐 C# | 📅 2026-09-07 - Deserialization payload generator for a variety of .NET formatters
...
* [OpenRedireX](https://github.com/devanshbatham/OpenRedireX) ⭐ 810 | 🐛 5 | 🌐 Python | 📅 2024-07-01 - A Fuzzer for OpenRedirect issues
* [Injectus](https://github.com/BountyStrike/Injectus) ⚠️ Archived - CRLF and open redirect fuzzer
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,500 | 🐛 31 | 🌐 Python | 📅 2026-09-23 - Automatic SQL injection and database takeover tool
* [ghauri](https://github.com/r0oth3x49/ghauri) ⭐ 4,079 | 🐛 25 | 🌐 Python | 📅 2025-10-04 - An advanced cross-platform tool that automates the process of detecting and exploiting SQL injection security flaws
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,188 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,298 | 🐛 3 | 🌐 Rust | 📅 2026-09-23 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
* [ezXSS](https://github.com/ssl/ezXSS) ⭐ 2,336 | 🐛 5 | 🌐 PHP | 📅 2026-07-08 - ezXSS is an easy way for penetration testers and bug bounty hunters to test (blind) Cross Site Scripting.
* [xssor2](https://github.com/evilcos/xssor2) ⭐ 2,221 | 🐛 4 | 🌐 JavaScript | 📅 2021-12-12 - XSS'OR - Hack with JavaScript.
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,883 | 🐛 4 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
* [nowafpls](https://github.com/assetnote/nowafpls/) ⭐ 1,510 | 🐛 4 | 🌐 Python | 📅 2025-07-14 - Burp Plugin to Bypass WAFs through the insertion of Junk Data.
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,298 | 🐛 50 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,753 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,450 | 🐛 482 | 🌐 Go | 📅 2026-09-23 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 28,029 | 🐛 567 | 🌐 Go | 📅 2026-09-23 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,403 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
* [keyhacks](https://github.com/streaak/keyhacks) ⭐ 6,338 | 🐛 45 | 📅 2026-08-07 - KeyHacks shows methods to validate different API keys found on a Bug Bounty Program or a pentest.
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,777 | 🐛 15 | 🌐 Go | 📅 2026-09-21 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [js-snitch](https://github.com/vavkamil/js-snitch) ⭐ 150 | 🐛 1 | 🌐 Python | 📅 2025-01-21 - Scans remote JavaScript files with Trufflehog + Semgrep to detect leaked secrets.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,563 | 🐛 161 | 🌐 Rust | 📅 2026-09-21 - Static analysis tool for GitHub Actions
* [GitTools](https://github.com/internetwache/GitTools) ⭐ 4,181 | 🐛 2 | 🌐 Shell | 📅 2026-07-15 - A repository with 3 tools for pwn'ing websites with .git repositories available
* [git-dumper](https://github.com/arthaud/git-dumper) ⭐ 2,667 | 🐛 10 | 🌐 Python | 📅 2026-09-06 - A tool to dump a git repository from a website
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,776 | 🐛 5 | 🌐 Ruby | 📅 2026-09-21 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [jwt\_tool](https://github.com/ticarpi/jwt_tool) ⭐ 6,765 | 🐛 75 | 🌐 Python | 📅 2025-05-01 - A toolkit for testing, tweaking and cracking JSON Web Tokens
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,083 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - jwt-hack is tool for hacking / security testing to JWT.
...
* [dnsReaper](https://github.com/punk-security/dnsReaper) ⭐ 2,218 | 🐛 33 | 🌐 Python | 📅 2025-10-06 - DNS Reaper is yet another sub-domain takeover tool, but with an emphasis on accuracy, speed and the number of signatures in our arsenal!
* [subjack](https://github.com/haccer/subjack) ⭐ 2,115 | 🐛 3 | 🌐 Go | 📅 2026-07-03 - Subdomain Takeover tool written in Go
* [subzy](https://github.com/PentestPad/subzy) ⭐ 1,598 | 🐛 10 | 🌐 Go | 📅 2024-09-10 - Subdomain takeover tool which works based on matching response fingerprints from `can-i-take-over-xyz`.
* [SubOver](https://github.com/Ice3man543/SubOver) ⭐ 971 | 🐛 12 | 🌐 Go | 📅 2023-10-17 - A Powerful Subdomain Takeover Tool
* [tko-subs](https://github.com/anshumanbh/tko-subs) ⭐ 773 | 🐛 4 | 🌐 Go | 📅 2021-01-03 - A tool that can help detect and takeover subdomains with dead DNS records
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,042 | 🐛 615 | 🌐 Ruby | 📅 2026-09-21 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,457 | 🐛 110 | 🌐 Go | 📅 2026-09-23 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,812 | 🐛 865 | 🌐 Java | 📅 2026-09-23 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 13,016 | 🐛 108 | 🌐 JavaScript | 📅 2026-09-23 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,266 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,739 | 🐛 1 | 🌐 Perl | 📅 2026-09-23 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,576 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,178 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,082 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [OWASP PTK](https://github.com/DenisPodgurskii/pentestkit) ⭐ 239 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 -  Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* [alterx](https://github.com/projectdiscovery/alterx) ⭐ 1,006 | 🐛 6 | 🌐 Go | 📅 2026-09-21 - Fast and customizable subdomain wordlist generator using DSL. alterx takes patterns as input and generates subdomain permutation wordlist based on that pattern.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,932 | 🐛 586 | 🌐 JavaScript | 📅 2026-09-23 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,543 | 🐛 3 | 🌐 Go | 📅 2026-09-23 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 48,315 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-21 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,571 | 🐛 87 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 5,149 | 🐛 7 | 🌐 Python | 📅 2026-09-23 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 966 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 81,141 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,682 | 🐛 10 | 🌐 PHP | 📅 2026-09-23 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
...
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,959 | 🐛 0 | 📅 2026-09-22 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,545 | 🐛 12 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,667 | 🐛 14 | 🌐 Go | 📅 2026-09-21 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [awesome-vulnerable-apps](https://github.com/vavkamil/awesome-vulnerable-apps) ⭐ 1,485 | 🐛 4 | 📅 2026-06-15 - Awesome Vulnerable Applications
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 388 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
