...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,149 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,420 | 🐛 6 | 🌐 Go | 📅 2026-09-11 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,566 | 🐛 48 | 🌐 Python | 📅 2026-09-07 - A recursive internet scanner for hackers
...
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,794 | 🐛 3 | 🌐 Rust | 📅 2026-09-11 - The fastest and cross-platform subdomain enumerator, do not waste your time.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,003 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,402 | 🐛 62 | 🌐 Rust | 📅 2026-09-09 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,569 | 🐛 687 | 🌐 C | 📅 2026-09-11 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,241 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,847 | 🐛 30 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
* [Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived - Recovers passwords from pixelized screenshots
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,504 | 🐛 44 | 🌐 Go | 📅 2026-04-22 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,014 | 🐛 3 | 🌐 Python | 📅 2026-09-11 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpscreenshot](https://github.com/breenmachine/httpscreenshot/) ⭐ 649 | 🐛 15 | 🌐 Python | 📅 2024-10-01 - HTTPScreenshot is a tool for grabbing screenshots and HTML of large numbers of websites.
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,387 | 🐛 7 | 🌐 Go | 📅 2026-09-11 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,835 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,171 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-12 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,478 | 🐛 17 | 🌐 Go | 📅 2026-09-11 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,718 | 🐛 23 | 🌐 Python | 📅 2026-09-12 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,110 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,064 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
* [hakrawler](https://github.com/hakluke/hakrawler) ⭐ 5,127 | 🐛 9 | 🌐 Go | 📅 2026-08-05 - Simple, fast web crawler designed for easy, quick discovery of endpoints and assets within a web application
* [kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,262 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - Fast API endpoint bruteforcer and content discovery tool for modern web applications.
...
* [gau](https://github.com/lc/gau) ⭐ 5,086 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
* [waybackurls](https://github.com/tomnomnom/waybackurls) ⭐ 4,557 | 🐛 48 | 🌐 Go | 📅 2024-05-01 - Fetch all the URLs that the Wayback Machine knows about for a domain
...
* [waymore](https://github.com/xnl-h4ck3r/waymore) ⭐ 2,744 | 🐛 4 | 🌐 Python | 📅 2026-06-11 -  Find way more from the Wayback Machine!
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,923 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,668 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,577 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,841 | 🐛 6 | 🌐 Python | 📅 2026-09-12 - Automated All-in-One OS command injection and exploitation tool.
...
* [phpggc](https://github.com/ambionics/phpggc) ⭐ 3,887 | 🐛 22 | 🌐 PHP | 📅 2025-09-29 - PHPGGC is a library of PHP unserialize() payloads along with a tool to generate them, from command line or programmatically.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,425 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - Automatic SQL injection and database takeover tool
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,179 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,290 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,264 | 🐛 49 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,262 | 🐛 474 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,824 | 🐛 557 | 🌐 Go | 📅 2026-09-12 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,392 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,768 | 🐛 14 | 🌐 Go | 📅 2026-09-07 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
* [SecretFinder](https://github.com/m4ll0k/SecretFinder) ⭐ 2,510 | 🐛 49 | 🌐 Python | 📅 2024-05-26 - A python script for finding sensitive data (apikeys, accesstoken,jwt,..) and search anything on javascript files.
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 712 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - A Chrome extension that passively scans web pages for API keys, tokens, and secrets using 80+ regex patterns and Shannon entropy analysis across 10 attack surfaces.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,483 | 🐛 161 | 🌐 Rust | 📅 2026-09-11 - Static analysis tool for GitHub Actions
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,765 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,082 | 🐛 0 | 🌐 Rust | 📅 2026-09-06 - jwt-hack is tool for hacking / security testing to JWT.
...
* [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) ⭐ 5,809 | 🐛 215 | 🌐 Python | 📅 2025-02-08 - "Can I take over XYZ?" — a list of services and how to claim (sub)domains with dangling DNS records.
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,992 | 🐛 606 | 🌐 Ruby | 📅 2026-09-11 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,124 | 🐛 99 | 🌐 Go | 📅 2026-09-11 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,764 | 🐛 862 | 🌐 Java | 📅 2026-09-10 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,961 | 🐛 136 | 🌐 JavaScript | 📅 2026-09-12 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,227 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,720 | 🐛 1 | 🌐 Perl | 📅 2026-09-11 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,559 | 🐛 3 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,171 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-12 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,091 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,021 | 🐛 488 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,764 | 🐛 862 | 🌐 Java | 📅 2026-09-10 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,471 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,812 | 🐛 581 | 🌐 JavaScript | 📅 2026-09-11 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,529 | 🐛 10 | 🌐 Go | 📅 2026-09-09 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,939 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-08 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,446 | 🐛 79 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,748 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 919 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,825 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,463 | 🐛 8 | 🌐 PHP | 📅 2026-09-12 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
...
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,951 | 🐛 0 | 📅 2026-09-12 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,534 | 🐛 12 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,658 | 🐛 12 | 🌐 Go | 📅 2026-09-07 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 377 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
* [cut-cdn](https://github.com/ImAyrix/cut-cdn) ⭐ 353 | 🐛 3 | 🌐 Go | 📅 2026-08-16 - Removing CDN IPs from the list of IP addresses.
* [ARS3NAL](https://github.com/inflictx/Arsenal) ⭐ 174 | 🐛 4 | 🌐 CSS | 📅 2026-07-09 - Offline-first, searchable arsenal for pentest & bug bounty: \~1500 payloads, a click-to-build command generator, GTFOBins, wordlists, an embedded CyberChef, reverse shells and 70 checklists. Self-hosted web app with a live static demo.
