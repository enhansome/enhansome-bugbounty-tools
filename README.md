...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,213 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,499 | 🐛 6 | 🌐 Go | 📅 2026-09-24 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,615 | 🐛 43 | 🌐 Python | 📅 2026-09-24 - A recursive internet scanner for hackers
...
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,795 | 🐛 7 | 🌐 Rust | 📅 2026-09-23 - The fastest and cross-platform subdomain enumerator, do not waste your time.
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,879 | 🐛 3 | 🌐 Go | 📅 2026-09-21 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
* [altdns](https://github.com/infosec-au/altdns) ⭐ 2,506 | 🐛 18 | 🌐 Python | 📅 2025-01-09 - Generates permutations, alterations and mutations of subdomains and then resolves them
* [Sudomy](https://github.com/Screetsec/Sudomy) ⭐ 2,432 | 🐛 42 | 🌐 Shell | 📅 2024-06-27 - Sudomy is a subdomain enumeration tool to collect subdomains and analyzing domains performing automated reconnaissance (recon) for bug hunting / pentesting
...
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,671 | 🐛 4 | 🌐 Go | 📅 2026-09-23 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [dnscan](https://github.com/rbsec/dnscan) ⭐ 1,280 | 🐛 6 | 🌐 Python | 📅 2024-12-17 - dnscan is a python wordlist-based DNS subdomain scanner.
* [scilla](https://github.com/edoardottt/scilla) ⭐ 1,272 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - Information Gathering tool - DNS / Subdomains / Ports / Directories enumeration
* [domain](https://github.com/jhaddix/domain/) ⭐ 941 | 🐛 21 | 🌐 Python | 📅 2020-11-17 - enumall.py Setup script for Regon-ng
* [chaos-client](https://github.com/projectdiscovery/chaos-client) ⭐ 885 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - Go client to communicate with Chaos DNS API.
...
* [subdominator](https://github.com/RevoltSecurities/Subdominator) ⭐ 807 | 🐛 5 | 🌐 Python | 📅 2026-06-21 - Fast and powerfull to enumerate subdomains (50+ passive results ).
...
* [csprecon](https://github.com/edoardottt/csprecon) ⭐ 527 | 🐛 3 | 🌐 Go | 📅 2026-09-21 - Discover new target domains using Content Security Policy
* [hakip2host](https://github.com/hakluke/hakip2host) ⭐ 464 | 🐛 1 | 🌐 Go | 📅 2022-04-27 - hakip2host takes a list of IP addresses via stdin, then does a series of checks to return associated domain names.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,033 | 🐛 415 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,451 | 🐛 55 | 🌐 Rust | 📅 2026-09-23 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,660 | 🐛 700 | 🌐 C | 📅 2026-09-24 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,266 | 🐛 3 | 🌐 Go | 📅 2026-09-21 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [NimScan](https://github.com/elddy/NimScan/) ⭐ 408 | 🐛 7 | 🌐 Nim | 📅 2022-02-10 - Fast Port Scanner 🚀
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,852 | 🐛 30 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
* [Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived - Recovers passwords from pixelized screenshots
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,519 | 🐛 36 | 🌐 Go | 📅 2026-09-16 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,967 | 🐛 3 | 🌐 Python | 📅 2026-09-23 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,424 | 🐛 11 | 🌐 Go | 📅 2026-09-23 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,854 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,555 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,179 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - scanner detecting the use of JavaScript libraries with known vulnerabilities
* [webanalyze](https://github.com/rverton/webanalyze) ⭐ 1,177 | 🐛 4 | 🌐 Go | 📅 2026-09-19 - Port of Wappalyzer (uncovers technologies used on websites) to automate mass scanning.
* [tlsx](https://github.com/projectdiscovery/tlsx) ⭐ 1,142 | 🐛 6 | 🌐 Go | 📅 2026-09-07 - A fast and configurable TLS grabber focused on TLS based data collection and analysis.
* [cdncheck](https://github.com/projectdiscovery/cdncheck) ⭐ 990 | 🐛 9 | 🌐 Go | 📅 2026-09-21 - cdncheck is a tool for identifying the technology associated with dns / ip network addresses.
* [graphw00f](https://github.com/dolevf/graphw00f) ⭐ 902 | 🐛 3 | 🌐 Python | 📅 2026-05-16 - graphw00f is GraphQL Server Engine Fingerprinting utility for software security professionals looking to learn more about what technology is behind a given GraphQL endpoint.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,563 | 🐛 22 | 🌐 Go | 📅 2026-09-23 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,752 | 🐛 24 | 🌐 Python | 📅 2026-09-24 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,153 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,083 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
* [hakrawler](https://github.com/hakluke/hakrawler) ⭐ 5,133 | 🐛 9 | 🌐 Go | 📅 2026-08-05 - Simple, fast web crawler designed for easy, quick discovery of endpoints and assets within a web application
* [kiterunner](https://github.com/assetnote/kiterunner) ⭐ 3,266 | 🐛 51 | 🌐 Go | 📅 2026-07-10 - Fast API endpoint bruteforcer and content discovery tool for modern web applications.
* [uncover](https://github.com/projectdiscovery/uncover) ⭐ 3,063 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - uncover is a go wrapper using APIs of well known search engines to quickly discover exposed hosts on the internet.
...
* [crawley](https://github.com/s0rg/crawley) ⭐ 338 | 🐛 8 | 🌐 Go | 📅 2026-09-11 - fast, feature-rich unix-way web scraper/crawler written in Golang.
...
* [Hacker-Scoper](https://github.com/ItsIgnacioPortal/Hacker-Scoper) ⭐ 78 | 🐛 5 | 🌐 Go | 📅 2026-07-03 - CLI tool for filtering a mixed list of targets (URLs/IPs) according to the bug-bounty program's scope. The scope can be supplied manually, or it can also be detected automatically by just giving hacker-scoper the name of the targeted company. Hacker-Scoper supports IPs, URLs, wildcards, CIDR ranges, Nmap octet ranges, and even full Regex scopes.

### Links

* [gau](https://github.com/lc/gau) ⭐ 5,100 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
...
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,447 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - A python script that finds endpoints in JavaScript files
* [waymore](https://github.com/xnl-h4ck3r/waymore) ⭐ 2,752 | 🐛 4 | 🌐 Python | 📅 2026-06-11 -  Find way more from the Wayback Machine!
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,933 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [getJS](https://github.com/003random/getJS) ⭐ 900 | 🐛 1 | 🌐 Go | 📅 2026-08-29 -  A tool to fastly get all javascript sources/files
...
* [jsleak](https://github.com/byt3hx/jsleak) ⭐ 595 | 🐛 5 | 🌐 Go | 📅 2025-09-25 - jsleak is a tool to find secret , paths or links in JavaScript files or source code.
* [GoLinkFinder](https://github.com/0xsha/GoLinkFinder) ⭐ 393 | 🐛 1 | 🌐 Go | 📅 2024-11-10 - A fast and minimal JS endpoint extractor
* [urlgrab](https://github.com/IAmStoxe/urlgrab) ⭐ 345 | 🐛 7 | 🌐 Go | 📅 2020-11-07 - A golang utility to spider through a website searching for additional links.
...
* [github-endpoints](https://github.com/gwen001/github-endpoints) ⭐ 225 | 🐛 5 | 🌐 Go | 📅 2023-03-28 - This Go tool performs searches on GitHub and parses the results to find endpoints of a given domain.
* [linx](https://github.com/riza/linx) ⭐ 214 | 🐛 0 | 🌐 Go | 📅 2025-05-21 - Reveals invisible links within JavaScript files
* [jsfinder](https://github.com/kacakb/jsfinder) ⭐ 139 | 🐛 2 | 🌐 Go | 📅 2023-05-08 - A tool that scans web pages to find JavaScript file URLs linked in the HTML source code.
...
* [Arjun](https://github.com/s0md3v/Arjun) ⭐ 6,400 | 🐛 24 | 🌐 Python | 📅 2025-02-20 - HTTP parameter discovery suite.
* [ParamSpider](https://github.com/devanshbatham/ParamSpider) ⭐ 3,173 | 🐛 39 | 🌐 Python | 📅 2026-03-07 - Mining parameters from dark corners of Web Archives.
* [x8](https://github.com/Sh1Yo/x8) ⭐ 2,095 | 🐛 27 | 🌐 Rust | 📅 2024-09-08 - Hidden parameters discovery suite written in Rust.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,713 | 🐛 231 | 🌐 Go | 📅 2026-09-24 -  Fast web fuzzer written in Go
* [fuzzdb](https://github.com/fuzzdb-project/fuzzdb) ⭐ 8,990 | 🐛 15 | 🌐 PHP | 📅 2023-11-10 - Dictionary of attack patterns and primitives for black-box application fault injection and resource discovery.
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,581 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application fuzzer
* [IntruderPayloads](https://github.com/1N3/IntruderPayloads) ⭐ 3,979 | 🐛 4 | 🌐 BlitzBasic | 📅 2021-09-27 - A collection of Burpsuite Intruder payloads, BurpBounty payloads, fuzz lists, malicious file uploads and web pentesting methodologies and checklists.
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,329 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,345 | 🐛 74 | 🌐 Swift | 📅 2026-09-24 - A JavaScript Engine Fuzzer
...
* [bbscope](https://github.com/sw33tLie/bbscope) ⭐ 1,442 | 🐛 17 | 🌐 Go | 📅 2026-09-02 - Scope aggregation tool for HackerOne, Bugcrowd, Intigriti, YesWeHack, Immunefi
* [jsmon](https://github.com/robre/jsmon) ⭐ 735 | 🐛 10 | 🌐 Python | 📅 2024-07-31 - A Javascript change monitoring tool for Bug Bounty.
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,856 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Automated All-in-One OS command injection and exploitation tool.

### CORS Misconfiguration

* [Corsy](https://github.com/s0md3v/Corsy) ⭐ 1,537 | 🐛 13 | 🌐 Python | 📅 2022-09-17 - CORS Misconfiguration Scanner
* [CORStest](https://github.com/RUB-NDS/CORStest) ⭐ 422 | 🐛 7 | 🌐 Python | 📅 2020-08-14 - A simple CORS misconfiguration scanner
* [CorsMe](https://github.com/Shivangx01b/CorsMe) ⭐ 172 | 🐛 4 | 🌐 Go | 📅 2021-11-17 - Cross Origin Resource Sharing MisConfiguration Scanner
* [Corser](https://github.com/cyinnove/corser) ⭐ 59 | 🐛 1 | 🌐 Go | 📅 2024-10-26 - Corser is a Golang CLI Application for Advanced CORS Misconfiguration Detection.
...
* [crlfuzz](https://github.com/dwisiswant0/crlfuzz) ⭐ 1,565 | 🐛 1 | 🌐 Go | 📅 2026-08-28 - A fast tool to scan CRLF vulnerability written in Go
...
* [XSRFProbe](https://github.com/0xInfection/XSRFProbe) ⭐ 1,306 | 🐛 0 | 🌐 Python | 📅 2026-07-12 -The Prime Cross Site Request Forgery (CSRF) Audit and Exploitation Toolkit.
...
* [LFISuite](https://github.com/D35m0nd142/LFISuite) ⭐ 1,968 | 🐛 28 | 🌐 Python | 📅 2022-04-13 - Totally Automatic LFI Exploiter (+ Reverse Shell) and Scanner
* [liffy](https://github.com/mzfr/liffy) ⭐ 993 | 🐛 1 | 🌐 Python | 📅 2026-05-19 - Local file inclusion exploitation tool
...
* [clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,527 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Obtain GraphQL API schema despite disabled introspection!
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,065 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [Autorize](https://github.com/Quitten/Autorize) ⭐ 1,173 | 🐛 11 | 🌐 Python | 📅 2026-03-21 - Automatic authorization enforcement detection extension for burp suite written in Jython developed by Barak Tawily

### Open Redirect

* [Oralyzer](https://github.com/r0075h3ll/Oralyzer) ⭐ 826 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - Open Redirection Analyzer
* [OpenRedireX](https://github.com/devanshbatham/OpenRedireX) ⭐ 808 | 🐛 5 | 🌐 Python | 📅 2024-07-01 - A Fuzzer for OpenRedirect issues
* [Injectus](https://github.com/BountyStrike/Injectus) ⚠️ Archived - CRLF and open redirect fuzzer
...
* [smuggler](https://github.com/defparam/smuggler) ⭐ 2,107 | 🐛 19 | 🌐 Python | 📅 2024-01-02 - Smuggler - An HTTP Request Smuggling / Desync testing tool written in Python 3
* [h2csmuggler](https://github.com/BishopFox/h2csmuggler) ⭐ 817 | 🐛 15 | 🌐 Python | 📅 2022-05-10 - HTTP Request Smuggling over HTTP/2 Cleartext (h2c)
...
* [SSRFmap](https://github.com/swisskyrepo/SSRFmap) ⭐ 3,624 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - Automatic SSRF fuzzer and exploitation tool
* [Gopherus](https://github.com/tarunkant/Gopherus) ⭐ 3,417 | 🐛 11 | 🌐 Python | 📅 2023-04-18 - This tool generates gopher link for exploiting SSRF and gaining RCE in various servers
...
* [surf](https://github.com/assetnote/surf) ⭐ 756 | 🐛 2 | 🌐 Go | 📅 2026-07-10 - Escalate your SSRF vulnerabilities on Modern Cloud Environments. `surf` allows you to filter a list of hosts, returning a list of viable SSRF candidates.
...
* [extended-ssrf-search](https://github.com/Damian89/extended-ssrf-search) ⭐ 275 | 🐛 2 | 🌐 Python | 📅 2021-02-11 - Smart ssrf scanner using different methods like parameter brute forcing in post and get...
...
* [ssrfDetector](https://github.com/JacobReynolds/ssrfDetector) ⭐ 164 | 🐛 2 | 🌐 JavaScript | 📅 2017-06-26 - Server-side request forgery detector
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,507 | 🐛 31 | 🌐 Python | 📅 2026-09-23 - Automatic SQL injection and database takeover tool
* [ghauri](https://github.com/r0oth3x49/ghauri) ⭐ 4,078 | 🐛 25 | 🌐 Python | 📅 2025-10-04 - An advanced cross-platform tool that automates the process of detecting and exploiting SQL injection security flaws
* [NoSQLMap](https://github.com/codingo/NoSQLMap) ⭐ 3,353 | 🐛 1 | 🌐 Python | 📅 2026-07-28 - Automated NoSQL database enumeration and web application exploitation tool.
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,190 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,301 | 🐛 0 | 🌐 Rust | 📅 2026-09-24 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [xssor2](https://github.com/evilcos/xssor2) ⭐ 2,220 | 🐛 4 | 🌐 JavaScript | 📅 2021-12-12 - XSS'OR - Hack with JavaScript.
* [xsscrapy](https://github.com/DanMcInerney/xsscrapy) ⭐ 1,744 | 🐛 38 | 🌐 Python | 📅 2024-06-13 - XSS spider - 66/66 wavsep XSS detected
...
* [xsser](https://github.com/epsylon/xsser) ⭐ 1,467 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Cross Site "Scripter" (aka XSSer) is an automatic -framework- to detect, exploit and report XSS vulnerabilities in web-based applications.
* [weaponised-XSS-payloads](https://github.com/hakluke/weaponised-XSS-payloads) ⭐ 1,407 | 🐛 2 | 🌐 JavaScript | 📅 2023-09-12 - XSS payloads designed to turn alert(1) into P1
...
* [CSPBypass](https://github.com/renniepak/CSPBypass) ⭐ 718 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 - a tool designed to help bypass restrictive Content Security Policies (CSP) and exploit XSS (Cross-Site Scripting) vulnerabilities on sites where injections are blocked by CSPs that only allow certain whitelisted domains.
...
* [xss2png](https://github.com/vavkamil/xss2png) ⭐ 219 | 🐛 1 | 🌐 Python | 📅 2022-10-11 - PNG IDAT chunks XSS payload generator
...
* [Xss-Sql-Fuzz](https://github.com/jiangsir404/Xss-Sql-Fuzz) ⭐ 62 | 🐛 0 | 🌐 Python | 📅 2018-12-04 - burpsuite 插件对GP所有参数(过滤特殊参数)一键自动添加xss sql payload 进行fuzz
...
* [oxml\_xxe](https://github.com/BuffaloWill/oxml_xxe) ⭐ 1,177 | 🐛 2 | 🌐 Ruby | 📅 2024-12-16 - A tool for embedding XXE/XML exploits into different filetypes
* [docem](https://github.com/whitel1st/docem) ⭐ 689 | 🐛 1 | 🌐 Python | 📅 2024-01-28 - Uility to embed XXE and XSS payloads in docx,odt,pptx,etc (OXML\_XEE on steroids)
...
* [tplmap](https://github.com/epinna/tplmap) ⭐ 4,204 | 🐛 46 | 🌐 Python | 📅 2024-04-21 - Server-Side Template Injection and Code Injection Detection and Exploitation Tool
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,643 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - Automatic SSTI detection tool with interactive interface

### Web-Cache-Poisoning

* [toxicache](https://github.com/xhzeem/toxicache) ⭐ 149 | 🐛 1 | 🌐 Go | 📅 2024-02-21 - Go scanner to find web cache poisoning vulnerabilities in a list of URLs .

### Waf Evasion

* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,881 | 🐛 4 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
* [nowafpls](https://github.com/assetnote/nowafpls/) ⭐ 1,509 | 🐛 4 | 🌐 Python | 📅 2025-07-14 - Burp Plugin to Bypass WAFs through the insertion of Junk Data.
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,304 | 🐛 50 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,754 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
* [patator](https://github.com/lanjelot/patator) ⭐ 3,930 | 🐛 37 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design and a flexible usage.
* [BruteX](https://github.com/1N3/BruteX) ⭐ 2,306 | 🐛 10 | 🌐 Shell | 📅 2024-08-18 - Automatically brute force all services running on a target.
* [changeme](https://github.com/ztgrace/changeme) ⭐ 1,515 | 🐛 16 | 🌐 Python | 📅 2025-07-08 - A default credential scanner.

### Secrets

* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,465 | 🐛 484 | 🌐 Go | 📅 2026-09-23 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 28,039 | 🐛 554 | 🌐 Go | 📅 2026-09-24 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,404 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
* [keyhacks](https://github.com/streaak/keyhacks) ⭐ 6,341 | 🐛 45 | 📅 2026-08-07 - KeyHacks shows methods to validate different API keys found on a Bug Bounty Program or a pentest.
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,778 | 🐛 15 | 🌐 Go | 📅 2026-09-21 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,433 | 🐛 12 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [talisman](https://github.com/thoughtworks/talisman) ⭐ 2,097 | 🐛 39 | 🌐 Go | 📅 2026-03-01 - By hooking into the pre-push hook provided by Git, Talisman validates the outgoing changeset for things that look suspicious - such as authorization tokens and private keys.
* [GitGot](https://github.com/BishopFox/GitGot) ⭐ 1,573 | 🐛 4 | 🌐 Python | 📅 2024-03-07 - Semi-automated, feedback-driven tool to rapidly search through troves of public data on GitHub for sensitive secrets.
* [github-search](https://github.com/gwen001/github-search) ⭐ 1,513 | 🐛 1 | 🌐 Python | 📅 2023-02-09 - Tools to perform basic search on GitHub.
* [GitHound](https://github.com/tillson/git-hound) ⭐ 1,462 | 🐛 4 | 🌐 Go | 📅 2026-02-10 - Recon tool leveraging Code Search API. Scans for exposed API keys across all of GitHub, not just known repos and orgs. Support for GitHub dorks.
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 718 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - A Chrome extension that passively scans web pages for API keys, tokens, and secrets using 80+ regex patterns and Shannon entropy analysis across 10 attack surfaces.
* [rusty-hog](https://github.com/newrelic/rusty-hog) ⭐ 559 | 🐛 18 | 🌐 Rust | 📅 2026-08-03 - A suite of secret scanners built in Rust for performance. Based on TruffleHog
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,569 | 🐛 161 | 🌐 Rust | 📅 2026-09-24 - Static analysis tool for GitHub Actions
* [GitTools](https://github.com/internetwache/GitTools) ⭐ 4,180 | 🐛 2 | 🌐 Shell | 📅 2026-07-15 - A repository with 3 tools for pwn'ing websites with .git repositories available
* [git-dumper](https://github.com/arthaud/git-dumper) ⭐ 2,668 | 🐛 10 | 🌐 Python | 📅 2026-09-06 - A tool to dump a git repository from a website
...
* [CloudBrute](https://github.com/0xsha/CloudBrute) ⭐ 1,148 | 🐛 0 | 🌐 Go | 📅 2025-03-09 - Awesome cloud enumerator
...
* [s3dns](https://github.com/olizimmermann/s3dns) ⭐ 129 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Passive DNS-based discovery of S3 (and other cloud) buckets by resolving CNAMEs and IPs during recon—ideal for stealthy and early identification of cloud storage exposures
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,778 | 🐛 6 | 🌐 Ruby | 📅 2026-09-23 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [Temodar Agent](https://github.com/xeloxa/temodar-agent) ⭐ 61 | 🐛 5 | 🌐 Python | 📅 2026-07-03 - AI-powered WordPress plugin/theme security analysis platform with Semgrep-based static analysis and agent-assisted investigation workflows
* [wprecon](https://github.com/blackcrw/wprecon) ⭐ 24 | 🐛 0 | 🌐 Go | 📅 2026-06-05 - Wordpress Recon

### JSON Web Token

* [jwt\_tool](https://github.com/ticarpi/jwt_tool) ⭐ 6,763 | 🐛 75 | 🌐 Python | 📅 2025-05-01 - A toolkit for testing, tweaking and cracking JSON Web Tokens
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,082 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 - jwt-hack is tool for hacking / security testing to JWT.
...
* [dnsReaper](https://github.com/punk-security/dnsReaper) ⭐ 2,219 | 🐛 33 | 🌐 Python | 📅 2025-10-06 - DNS Reaper is yet another sub-domain takeover tool, but with an emphasis on accuracy, speed and the number of signatures in our arsenal!
* [subjack](https://github.com/haccer/subjack) ⭐ 2,117 | 🐛 3 | 🌐 Go | 📅 2026-07-03 - Subdomain Takeover tool written in Go
* [subzy](https://github.com/PentestPad/subzy) ⭐ 1,597 | 🐛 10 | 🌐 Go | 📅 2024-09-10 - Subdomain takeover tool which works based on matching response fingerprints from `can-i-take-over-xyz`.
* [SubOver](https://github.com/Ice3man543/SubOver) ⭐ 970 | 🐛 12 | 🌐 Go | 📅 2023-10-17 - A Powerful Subdomain Takeover Tool
* [tko-subs](https://github.com/anshumanbh/tko-subs) ⭐ 774 | 🐛 4 | 🌐 Go | 📅 2021-01-03 - A tool that can help detect and takeover subdomains with dead DNS records
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,053 | 🐛 615 | 🌐 Ruby | 📅 2026-09-21 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,487 | 🐛 111 | 🌐 Go | 📅 2026-09-24 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,822 | 🐛 862 | 🌐 Java | 📅 2026-09-24 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 13,018 | 🐛 99 | 🌐 JavaScript | 📅 2026-09-24 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,265 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,740 | 🐛 1 | 🌐 Perl | 📅 2026-09-23 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,574 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,179 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,778 | 🐛 15 | 🌐 Go | 📅 2026-09-21 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
* [jaeles](https://github.com/jaeles-project/jaeles) ⭐ 2,373 | 🐛 32 | 🌐 Go | 📅 2026-06-20 - The Swiss Army knife for automated Web Application Testing
* [Findsploit](https://github.com/1N3/Findsploit) ⭐ 1,850 | 🐛 1 | 🌐 Shell | 📅 2021-09-27 - Find exploits in local and online databases instantly
* [getsploit](https://github.com/vulnersCom/getsploit) ⭐ 1,822 | 🐛 5 | 🌐 Python | 📅 2026-09-14 - Command line utility for searching and downloading exploits
...
* [SSTImap](https://github.com/vladko312/SSTImap) ⭐ 1,643 | 🐛 13 | 🌐 Python | 📅 2026-08-25 -  SSTImap is a penetration testing software that can check websites for Code Injection and Server-Side Template Injection vulnerabilities and exploit them, giving access to the operating system itself.
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,098 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,084 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [OWASP PTK](https://github.com/DenisPodgurskii/pentestkit) ⭐ 241 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 -  Browser-based vulnerability scanner for bug bounty and pentesting workflows, combining DAST, SAST, IAST, and SCA capabilities to detect runtime, source-level, interactive, and dependency-related security issues.
...
* [altdns](https://github.com/infosec-au/altdns) ⭐ 2,506 | 🐛 18 | 🌐 Python | 📅 2025-01-09 - Generates permutations, alterations and mutations of subdomains and then resolves them.
* [dnsgen](https://github.com/AlephNullSK/dnsgen) ⭐ 1,080 | 🐛 14 | 🌐 Python | 📅 2025-01-03 - DNSGen is a powerful and flexible DNS name permutation tool designed for security researchers and penetration testers. It generates intelligent domain name variations to assist in subdomain discovery and security assessments.
* [alterx](https://github.com/projectdiscovery/alterx) ⭐ 1,008 | 🐛 7 | 🌐 Go | 📅 2026-09-21 - Fast and customizable subdomain wordlist generator using DSL. alterx takes patterns as input and generates subdomain permutation wordlist based on that pattern.
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,143 | 🐛 496 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,822 | 🐛 862 | 🌐 Java | 📅 2026-09-24 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,496 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
* [proxify](https://github.com/projectdiscovery/proxify) ⭐ 3,070 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - A versatile and portable proxy for capturing, manipulating, and replaying HTTP/HTTPS traffic on the go.
* [FoxyProxy Browser Extension](https://github.com/foxyproxy/browser-extension) ⭐ 525 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-14 - FoxyProxy is an open-source, advanced proxy management tool that completely replaces Chrome's limited proxying capabilities.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,943 | 🐛 585 | 🌐 JavaScript | 📅 2026-09-23 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,548 | 🐛 10 | 🌐 Go | 📅 2026-09-24 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
* [gf](https://github.com/tomnomnom/gf) ⭐ 2,137 | 🐛 55 | 🌐 Go | 📅 2024-06-08 -  A wrapper around grep, to help you grep for things
* [anew](https://github.com/tomnomnom/anew) ⭐ 1,662 | 🐛 8 | 🌐 Go | 📅 2024-01-12 -  A tool for adding new lines to files, skipping duplicates
* [notify](https://github.com/projectdiscovery/notify) ⭐ 1,614 | 🐛 10 | 🌐 Go | 📅 2026-09-21 - Notify is a Go-based assistance package that enables you to stream the output of several tools (or read from a file) and publish it to a variety of supported platforms.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 48,346 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-21 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,578 | 🐛 87 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 5,157 | 🐛 8 | 🌐 Python | 📅 2026-09-24 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 966 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 81,166 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,696 | 🐛 10 | 🌐 PHP | 📅 2026-09-24 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
...
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,960 | 🐛 0 | 📅 2026-09-24 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,545 | 🐛 13 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,669 | 🐛 14 | 🌐 Go | 📅 2026-09-21 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [BigBountyRecon](https://github.com/Viralmaniar/BigBountyRecon) ⭐ 1,573 | 🐛 9 | 🌐 C# | 📅 2021-01-29 - BigBountyRecon tool utilises 58 different techniques using various Google dorks and open source tools to expedite the process of initial reconnaissance on the target organisation.
* [awesome-vulnerable-apps](https://github.com/vavkamil/awesome-vulnerable-apps) ⭐ 1,483 | 🐛 4 | 📅 2026-09-24 - Awesome Vulnerable Applications
* [mapcidr](https://github.com/projectdiscovery/mapcidr) ⭐ 1,232 | 🐛 0 | 🌐 Go | 📅 2026-09-21 - Utility program to perform multiple operations for a given subnet/CIDR ranges.
* [asnmap](https://github.com/projectdiscovery/asnmap) ⭐ 1,131 | 🐛 6 | 🌐 Go | 📅 2026-09-07 - Go CLI and Library for quickly mapping organization network ranges using ASN information.
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 388 | 🐛 1 | 🌐 Go | 📅 2026-09-23 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
