...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,157 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,425 | 🐛 6 | 🌐 Go | 📅 2026-09-14 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,570 | 🐛 51 | 🌐 Python | 📅 2026-09-13 - A recursive internet scanner for hackers
* [knock](https://github.com/guelfoweb/knock) ⭐ 4,197 | 🐛 72 | 🌐 Python | 📅 2026-02-19 - Knockpy is a python tool designed to enumerate subdomains on a target domain through a wordlist.
* [Findomain](https://github.com/Findomain/Findomain) ⭐ 3,795 | 🐛 3 | 🌐 Rust | 📅 2026-09-11 - The fastest and cross-platform subdomain enumerator, do not waste your time.
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,868 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [dnscan](https://github.com/rbsec/dnscan) ⭐ 1,279 | 🐛 6 | 🌐 Python | 📅 2024-12-17 - dnscan is a python wordlist-based DNS subdomain scanner.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,011 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,407 | 🐛 62 | 🌐 Rust | 📅 2026-09-09 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,585 | 🐛 690 | 🌐 C | 📅 2026-09-11 - Nmap - the Network Mapper. Github mirror of official SVN repository.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,506 | 🐛 37 | 🌐 Go | 📅 2026-09-14 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,023 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,393 | 🐛 8 | 🌐 Go | 📅 2026-09-14 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,836 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,171 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-14 - scanner detecting the use of JavaScript libraries with known vulnerabilities
* [webanalyze](https://github.com/rverton/webanalyze) ⭐ 1,176 | 🐛 4 | 🌐 Go | 📅 2026-08-28 - Port of Wappalyzer (uncovers technologies used on websites) to automate mass scanning.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,507 | 🐛 23 | 🌐 Go | 📅 2026-09-14 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,718 | 🐛 23 | 🌐 Python | 📅 2026-09-14 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,114 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,067 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [gau](https://github.com/lc/gau) ⭐ 5,089 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
...
* [waymore](https://github.com/xnl-h4ck3r/waymore) ⭐ 2,749 | 🐛 4 | 🌐 Python | 📅 2026-06-11 -  Find way more from the Wayback Machine!
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,928 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [getJS](https://github.com/003random/getJS) ⭐ 899 | 🐛 1 | 🌐 Go | 📅 2026-08-29 -  A tool to fastly get all javascript sources/files
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,672 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [fuzzilli](https://github.com/googleprojectzero/fuzzilli) ⭐ 2,343 | 🐛 74 | 🌐 Swift | 📅 2026-09-10 - A JavaScript Engine Fuzzer
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,843 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - Automated All-in-One OS command injection and exploitation tool.
...
* [liffy](https://github.com/mzfr/liffy) ⭐ 988 | 🐛 1 | 🌐 Python | 📅 2026-05-19 - Local file inclusion exploitation tool
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,059 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,439 | 🐛 31 | 🌐 Python | 📅 2026-09-14 - Automatic SQL injection and database takeover tool
...
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,290 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,878 | 🐛 4 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,268 | 🐛 50 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,300 | 🐛 474 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,887 | 🐛 554 | 🌐 Go | 📅 2026-09-14 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,395 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,769 | 🐛 14 | 🌐 Go | 📅 2026-09-07 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 714 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - A Chrome extension that passively scans web pages for API keys, tokens, and secrets using 80+ regex patterns and Shannon entropy analysis across 10 attack surfaces.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,509 | 🐛 165 | 🌐 Rust | 📅 2026-09-14 - Static analysis tool for GitHub Actions
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,766 | 🐛 1 | 🌐 Ruby | 📅 2026-09-14 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,006 | 🐛 606 | 🌐 Ruby | 📅 2026-09-14 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,157 | 🐛 98 | 🌐 Go | 📅 2026-09-14 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,766 | 🐛 863 | 🌐 Java | 📅 2026-09-14 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,970 | 🐛 142 | 🌐 JavaScript | 📅 2026-09-14 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,233 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,724 | 🐛 1 | 🌐 Perl | 📅 2026-09-13 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,562 | 🐛 3 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,171 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-14 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,093 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,049 | 🐛 490 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,766 | 🐛 863 | 🌐 Java | 📅 2026-09-14 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,475 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
* [proxify](https://github.com/projectdiscovery/proxify) ⭐ 3,068 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - A versatile and portable proxy for capturing, manipulating, and replaying HTTP/HTTPS traffic on the go.
* [FoxyProxy Browser Extension](https://github.com/foxyproxy/browser-extension) ⭐ 519 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-26 - FoxyProxy is an open-source, advanced proxy management tool that completely replaces Chrome's limited proxying capabilities.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,838 | 🐛 594 | 🌐 JavaScript | 📅 2026-09-11 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,531 | 🐛 9 | 🌐 Go | 📅 2026-09-09 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [notify](https://github.com/projectdiscovery/notify) ⭐ 1,614 | 🐛 9 | 🌐 Go | 📅 2026-09-07 - Notify is a Go-based assistance package that enables you to stream the output of several tools (or read from a file) and publish it to a variety of supported platforms.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,998 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-08 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,463 | 🐛 80 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,768 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 933 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,853 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,505 | 🐛 8 | 🌐 PHP | 📅 2026-09-14 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,689 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,951 | 🐛 0 | 📅 2026-09-14 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
* [awesome-mobile-security](https://github.com/vaib25vicky/awesome-mobile-security) ⭐ 3,537 | 🐛 12 | 📅 2024-03-01 - An effort to build a single place for all useful android and iOS security related stuff.
* [cvemap](https://github.com/projectdiscovery/cvemap) ⭐ 2,659 | 🐛 14 | 🌐 Go | 📅 2026-09-14 - Modern CLI for exploring vulnerability data with powerful search, filtering, and analysis capabilities.
...
* [Bypass bot detection](https://github.com/portswigger/bypass-bot-detection) ⭐ 501 | 🐛 2 | 🌐 Java | 📅 2025-09-09 - Burp Suite extension that mutates ciphers to bypass TLS-fingerprint based bot detection.
