...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,152 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,422 | 🐛 6 | 🌐 Go | 📅 2026-09-11 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,569 | 🐛 51 | 🌐 Python | 📅 2026-09-13 - A recursive internet scanner for hackers
...
* [assetfinder](https://github.com/tomnomnom/assetfinder) ⭐ 3,677 | 🐛 43 | 🌐 Go | 📅 2024-06-07 - Find domains and subdomains related to a given domain
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,866 | 🐛 3 | 🌐 Go | 📅 2026-09-08 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [shuffledns](https://github.com/projectdiscovery/shuffledns) ⭐ 1,672 | 🐛 4 | 🌐 Go | 📅 2026-09-10 - shuffleDNS is a wrapper around massdns written in go that allows you to enumerate valid subdomains using active bruteforce as well as resolve subdomains with wildcard handling and easy input-output…
...
* [scilla](https://github.com/edoardottt/scilla) ⭐ 1,268 | 🐛 6 | 🌐 Go | 📅 2026-09-09 - Information Gathering tool - DNS / Subdomains / Ports / Directories enumeration
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,006 | 🐛 414 | 🌐 C | 📅 2026-04-23 - TCP port scanner, spews SYN packets asynchronously, scanning entire Internet in under 5 minutes.
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,403 | 🐛 62 | 🌐 Rust | 📅 2026-09-09 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,578 | 🐛 689 | 🌐 C | 📅 2026-09-11 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,247 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [EyeWitness](https://github.com/FortyNorthSecurity/EyeWitness) ⭐ 5,848 | 🐛 30 | 🌐 Python | 📅 2026-01-05 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible.
...
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,018 | 🐛 3 | 🌐 Python | 📅 2026-09-12 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,389 | 🐛 7 | 🌐 Go | 📅 2026-09-11 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,837 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
* [wafw00f](https://github.com/EnableSecurity/wafw00f) ⭐ 6,546 | 🐛 0 | 🌐 Python | 📅 2026-04-19 - wafw00f allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,171 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-13 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [cdncheck](https://github.com/projectdiscovery/cdncheck) ⭐ 988 | 🐛 6 | 🌐 Go | 📅 2026-09-13 - cdncheck is a tool for identifying the technology associated with dns / ip network addresses.
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,494 | 🐛 17 | 🌐 Go | 📅 2026-09-11 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,721 | 🐛 23 | 🌐 Python | 📅 2026-09-13 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,112 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,065 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [gau](https://github.com/lc/gau) ⭐ 5,088 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
...
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,445 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - A python script that finds endpoints in JavaScript files
* [waymore](https://github.com/xnl-h4ck3r/waymore) ⭐ 2,747 | 🐛 4 | 🌐 Python | 📅 2026-06-11 -  Find way more from the Wayback Machine!
* [jsluice](https://github.com/BishopFox/jsluice) ⭐ 1,927 | 🐛 9 | 🌐 Go | 📅 2024-05-22 - This tool extracts URLs, paths, secrets, and other interesting bits from JavaScript files. Values are extracted based not just on how they look, but also based on how they are used.
...
* [getJS](https://github.com/003random/getJS) ⭐ 898 | 🐛 1 | 🌐 Go | 📅 2026-08-29 -  A tool to fastly get all javascript sources/files
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,665 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,841 | 🐛 6 | 🌐 Python | 📅 2026-09-13 - Automated All-in-One OS command injection and exploitation tool.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,431 | 🐛 32 | 🌐 Python | 📅 2026-09-08 - Automatic SQL injection and database takeover tool
...
* [dalfox](https://github.com/hahwul/dalfox) ⭐ 5,289 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - DalFox(Finder Of XSS) / Parameter Analysis and XSS Scanning tool based on golang
...
* [docem](https://github.com/whitel1st/docem) ⭐ 689 | 🐛 1 | 🌐 Python | 📅 2024-01-28 - Uility to embed XXE and XSS payloads in docx,odt,pptx,etc (OXML\_XEE on steroids)
* [dtd-finder](https://github.com/GoSecure/dtd-finder) ⭐ 664 | 🐛 1 | 🌐 Kotlin | 📅 2024-02-21 - List DTDs and generate XXE payloads using those local DTDs.
...
* [nomore403](https://github.com/devploit/nomore403) ⭐ 1,877 | 🐛 4 | 🌐 Go | 📅 2026-06-21 - Advanced tool for security researchers to bypass 403/40X restrictions .
...
* [patator](https://github.com/lanjelot/patator) ⭐ 3,930 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design and a flexible usage.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,286 | 🐛 474 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,855 | 🐛 557 | 🌐 Go | 📅 2026-09-12 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,394 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Prevents you from committing secrets and credentials into git repositories
...
* [shhgit](https://github.com/eth0izzle/shhgit) ⭐ 3,982 | 🐛 33 | 🌐 JavaScript | 📅 2025-02-28 - Ah shhgit! Find GitHub secrets in real time
...
* [GitHound](https://github.com/tillson/git-hound) ⭐ 1,457 | 🐛 4 | 🌐 Go | 📅 2026-02-10 - Recon tool leveraging Code Search API. Scans for exposed API keys across all of GitHub, not just known repos and orgs. Support for GitHub dorks.
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,493 | 🐛 162 | 🌐 Rust | 📅 2026-09-11 - Static analysis tool for GitHub Actions
...
* [git-dumper](https://github.com/arthaud/git-dumper) ⭐ 2,659 | 🐛 10 | 🌐 Python | 📅 2026-09-06 - A tool to dump a git repository from a website
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,767 | 🐛 0 | 🌐 Ruby | 📅 2026-08-20 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [jwt-hack](https://github.com/hahwul/jwt-hack) ⭐ 1,081 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - jwt-hack is tool for hacking / security testing to JWT.
...
* [can-i-take-over-xyz](https://github.com/EdOverflow/can-i-take-over-xyz) ⭐ 5,811 | 🐛 215 | 🌐 Python | 📅 2025-02-08 - "Can I take over XYZ?" — a list of services and how to claim (sub)domains with dangling DNS records.
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,001 | 🐛 609 | 🌐 Ruby | 📅 2026-09-11 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,133 | 🐛 99 | 🌐 Go | 📅 2026-09-12 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,765 | 🐛 862 | 🌐 Java | 📅 2026-09-10 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,965 | 🐛 137 | 🌐 JavaScript | 📅 2026-09-13 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,231 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,722 | 🐛 1 | 🌐 Perl | 📅 2026-09-11 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,561 | 🐛 3 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,171 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-13 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [Lonkero](https://github.com/bountyyfi/lonkero) ⭐ 1,092 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - Enterprise-grade web vulnerability scanner with 60+ attack modules, built in Rust for penetration testing and security assessments.
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,069 | 🐛 5 | 🌐 Go | 📅 2026-09-13 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,034 | 🐛 490 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,765 | 🐛 862 | 🌐 Java | 📅 2026-09-10 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,475 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
...
* [FoxyProxy Browser Extension](https://github.com/foxyproxy/browser-extension) ⭐ 519 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-26 - FoxyProxy is an open-source, advanced proxy management tool that completely replaces Chrome's limited proxying capabilities.
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,825 | 🐛 589 | 🌐 JavaScript | 📅 2026-09-11 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,530 | 🐛 10 | 🌐 Go | 📅 2026-09-09 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
* [gf](https://github.com/tomnomnom/gf) ⭐ 2,140 | 🐛 55 | 🌐 Go | 📅 2024-06-08 -  A wrapper around grep, to help you grep for things
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 47,963 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-08 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,451 | 🐛 80 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,752 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 923 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,839 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,480 | 🐛 8 | 🌐 PHP | 📅 2026-09-13 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,688 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,951 | 🐛 0 | 📅 2026-09-13 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
...
* [mapcidr](https://github.com/projectdiscovery/mapcidr) ⭐ 1,227 | 🐛 0 | 🌐 Go | 📅 2026-09-12 - Utility program to perform multiple operations for a given subnet/CIDR ranges.
...
* [RF Swift](https://github.com/PentHertz/RF-Swift) ⭐ 378 | 🐛 1 | 🌐 Go | 📅 2026-09-08 - A powerful multi-platform RF toolbox that deploys specialized radio tools in seconds on Linux, Windows, and macOS—supporting x86\_64, ARM64 (Raspberry Pi, Apple Silicon), and RISC-V architectures without disrupting your primary OS.
