...
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,175 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth Attack Surface Mapping and Asset Discovery
* [subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,439 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Subfinder is a subdomain discovery tool that discovers valid subdomains for websites.
...
* [bbot](https://github.com/blacklanternsecurity/bbot) ⭐ 10,579 | 🐛 41 | 🌐 Python | 📅 2026-09-17 - A recursive internet scanner for hackers
...
* [dnsx](https://github.com/projectdiscovery/dnsx) ⭐ 2,870 | 🐛 3 | 🌐 Go | 📅 2026-09-14 - Dnsx is a fast and multi-purpose DNS toolkit allow to run multiple DNS queries of your choice with a list of user-supplied resolvers.
...
* [RustScan](https://github.com/RustScan/RustScan) ⭐ 20,424 | 🐛 53 | 🌐 Rust | 📅 2026-09-16 - The Modern Port Scanner
* [nmap](https://github.com/nmap/nmap) ⭐ 13,601 | 🐛 696 | 🌐 C | 📅 2026-09-16 - Nmap - the Network Mapper. Github mirror of official SVN repository.
* [naabu](https://github.com/projectdiscovery/naabu) ⭐ 6,250 | 🐛 1 | 🌐 Go | 📅 2026-09-14 - A fast port scanner written in go with focus on reliability and simplicity.
...
* [gowitness](https://github.com/sensepost/gowitness) ⭐ 4,512 | 🐛 36 | 🌐 Go | 📅 2026-09-16 - gowitness - a golang, web screenshot utility using Chrome Headless
* [invisible-playwright](https://github.com/feder-cr/invisible_playwright) ⭐ 2,045 | 🐛 4 | 🌐 Python | 📅 2026-09-16 - Playwright wrapper for a stealth-patched Firefox 150 binary, useful for screenshotting and recon against targets with anti-bot detection (reCAPTCHA v3, FingerprintPro, Cloudflare).
...
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,402 | 🐛 10 | 🌐 Go | 📅 2026-09-16 - httpx is a fast and multi-purpose HTTP toolkit allows to run multiple probers using retryablehttp library, it is designed to maintain the result reliability with increased threads.
* [whatweb](https://github.com/urbanadventurer/whatweb) ⭐ 6,844 | 🐛 51 | 🌐 Ruby | 📅 2026-04-02 - Next generation web scanner
...
* [katana](https://github.com/projectdiscovery/katana) ⭐ 17,518 | 🐛 24 | 🌐 Go | 📅 2026-09-14 - A next-generation crawling and spidering framework
* [dirsearch](https://github.com/maurosoria/dirsearch) ⭐ 14,731 | 🐛 24 | 🌐 Python | 📅 2026-09-17 - Web path scanner
* [gobuster](https://github.com/OJ/gobuster) ⭐ 14,125 | 🐛 24 | 🌐 Go | 📅 2026-09-09 - Directory/File, DNS and VHost busting tool written in Go
* [feroxbuster](https://github.com/epi052/feroxbuster) ⭐ 8,068 | 🐛 38 | 🌐 Rust | 📅 2026-09-05 - A fast, simple, recursive content discovery tool written in Rust.
...
* [gau](https://github.com/lc/gau) ⭐ 5,094 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - Fetch known URLs from AlienVault's Open Threat Exchange, the Wayback Machine, and Common Crawl.
...
* [ffuf](https://github.com/ffuf/ffuf) ⭐ 16,686 | 🐛 234 | 🌐 Go | 📅 2026-09-09 -  Fast web fuzzer written in Go
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,847 | 🐛 4 | 🌐 Python | 📅 2026-09-17 - Automated All-in-One OS command injection and exploitation tool.
...
* [ysoserial](https://github.com/frohoff/ysoserial) ⭐ 9,062 | 🐛 47 | 🌐 Java | 📅 2025-12-04 - A proof-of-concept tool for generating payloads that exploit unsafe Java object deserialization.
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,461 | 🐛 33 | 🌐 Python | 📅 2026-09-15 - Automatic SQL injection and database takeover tool
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,184 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - Most advanced XSS scanner.
...
* [nowafpls](https://github.com/assetnote/nowafpls/) ⭐ 1,505 | 🐛 3 | 🌐 Python | 📅 2025-07-14 - Burp Plugin to Bypass WAFs through the insertion of Junk Data.
...
* [thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,278 | 🐛 50 | 🌐 C | 📅 2026-07-30 - Hydra is a parallelized login cracker which supports numerous protocols to attack.
* [DefaultCreds-cheat-sheet](https://github.com/ihebski/DefaultCreds-cheat-sheet) ⭐ 6,742 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - One place for all the default credentials to assist the Blue/Red teamers activities on finding devices with default password
* [patator](https://github.com/lanjelot/patator) ⭐ 3,932 | 🐛 36 | 🌐 Python | 📅 2025-05-20 - Patator is a multi-purpose brute-forcer, with a modular design and a flexible usage.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,363 | 🐛 482 | 🌐 Go | 📅 2026-09-09 - Scan git repos (or files) for secrets using regex and entropy
* [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,968 | 🐛 555 | 🌐 Go | 📅 2026-09-17 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
...
* [cariddi](https://github.com/edoardottt/cariddi) ⭐ 3,772 | 🐛 14 | 🌐 Go | 📅 2026-09-07 - Take a list of domains, crawl urls and scan for endpoints, secrets, api keys, file extensions, tokens and more...
...
* [gitGraber](https://github.com/hisxo/gitGraber) ⭐ 2,413 | 🐛 12 | 🌐 Python | 📅 2026-03-26 - gitGraber: monitor GitHub to search and find sensitive data in real time for different online services
...
* [zizmor](https://github.com/zizmorcore/zizmor) ⭐ 6,527 | 🐛 161 | 🌐 Rust | 📅 2026-09-15 - Static analysis tool for GitHub Actions
...
* [git-dumper](https://github.com/arthaud/git-dumper) ⭐ 2,661 | 🐛 10 | 🌐 Python | 📅 2026-09-06 - A tool to dump a git repository from a website
...
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,771 | 🐛 1 | 🌐 Ruby | 📅 2026-09-14 - WPScan is a free, for non-commercial use, black box WordPress security scanner
...
* [metasploit-framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,019 | 🐛 603 | 🌐 Ruby | 📅 2026-09-17 - Metasploit Framework
* [nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,342 | 🐛 105 | 🌐 Go | 📅 2026-09-15 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,782 | 🐛 861 | 🌐 Java | 📅 2026-09-17 -  World’s most popular free web security tools and is actively maintained by a dedicated international team of volunteers
* [nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ⭐ 12,982 | 🐛 130 | 🌐 JavaScript | 📅 2026-09-17 - Community curated list of templates for the nuclei engine to find security vulnerabilities.
* [Sn1per](https://github.com/1N3/Sn1per) ⭐ 11,244 | 🐛 8 | 🌐 Shell | 📅 2026-07-04 - Automated pentest framework for offensive security experts
* [nikto](https://github.com/sullo/nikto) ⭐ 10,731 | 🐛 1 | 🌐 Perl | 📅 2026-09-15 - Nikto web server scanner
* [Osmedeus](https://github.com/j3ssie/Osmedeus) ⭐ 6,568 | 🐛 4 | 🌐 Go | 📅 2026-09-12 - Fully automated offensive security framework for reconnaissance and vulnerability scanning
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,173 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-14 - scanner detecting the use of JavaScript libraries with known vulnerabilities
...
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,074 | 🐛 5 | 🌐 Go | 📅 2026-09-14 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,079 | 🐛 491 | 🌐 Python | 📅 2026-09-10 - An interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers.
* [zaproxy](https://github.com/zaproxy/zaproxy) ⭐ 15,782 | 🐛 861 | 🌐 Java | 📅 2026-09-17 - ZAP is what is known as a “manipulator-in-the-middle proxy.” It stands between the tester’s browser and the web application so that it can intercept and inspect messages sent between browser and web application, modify the contents if needed, and then forward those packets on to the destination.
* [hetty](https://github.com/dstotijn/hetty) ⭐ 12,487 | 🐛 48 | 🌐 Go | 📅 2026-07-21 - hetty is a free opensource alternative to Burpsuite pro
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,867 | 🐛 593 | 🌐 JavaScript | 📅 2026-09-16 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [interactsh](https://github.com/projectdiscovery/interactsh) ⭐ 4,540 | 🐛 9 | 🌐 Go | 📅 2026-09-09 - Interactsh is an open-source tool for detecting out-of-band interactions. It is a tool designed to detect vulnerabilities that cause external interactions.
...
* [shannon](https://github.com/KeygraphHQ/shannon) ⭐ 48,099 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-08 - Fully autonomous AI hacker to find actual exploits in your web apps.
* [PentestGPT](https://github.com/GreyDGL/PentestGPT) ⭐ 15,507 | 🐛 81 | 🌐 Python | 📅 2026-07-14 - AI-powered penetration testing assistant that helps automate security testing workflows and vulnerability discovery.
* [Agentic Bug Bounty Hunter](https://github.com/Awarexone/Agentic-Bug-Hunter) ⭐ 4,887 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Claude Code plugin for autonomous bug bounty hunting across HackerOne, Bugcrowd, Intigriti and Immunefi — 15 skills, 33 commands and 9 agents covering recon-to-report, 21 web vuln classes, web3/meme-coin audits, LLM red-teaming, GraphQL/CORS/JWT/NoSQL scanners and persistent hunt memory. Works with or without a subscription.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 946 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - Open source (GPL-3.0) autonomous AI penetration testing platform that orchestrates 80+ tools over MCP with dedicated per-technology offensive sub-agents (GraphQL, Spring Boot, ASP.NET, Node.js, Flask, PHP, Ruby) and a per-finding evidence trail.

***

## Uncategorized

* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,935 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - A list of useful payloads and bypass for Web Application Security and Pentest/CTF
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,571 | 🐛 9 | 🌐 PHP | 📅 2026-09-17 - It's a collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.
* [android-security-awesome](https://github.com/ashishb/android-security-awesome) ⭐ 9,697 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07 - A collection of android security related resources
* [bounty-targets-data](https://github.com/arkadiyt/bounty-targets-data) ⭐ 3,952 | 🐛 0 | 📅 2026-09-17 - This repo contains hourly-updated data dumps of bug bounty platform scopes (like Hackerone/Bugcrowd/Intigriti/etc) that are eligible for reports
...
* [mapcidr](https://github.com/projectdiscovery/mapcidr) ⭐ 1,228 | 🐛 0 | 🌐 Go | 📅 2026-09-14 - Utility program to perform multiple operations for a given subnet/CIDR ranges.
